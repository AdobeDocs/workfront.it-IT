...
title: Accedere e aprire gli obiettivi in Obiettivi di Adobe Workfront
description: Questo articolo descrive come trovare e gestire gli obiettivi in Adobe Workfront.
author: Alina
...
Questo articolo descrive come trovare e gestire gli obiettivi strategici in Adobe Workfront.
...
1. (Facoltativo) Fai clic sul nome di un obiettivo per aprirlo o modificarlo.
...
Devi accedere a un singolo obiettivo per eseguire le seguenti azioni mentre gestisci i tuoi obiettivi:

* Modifica
* Aggiungi un risultato o un&#39;attività
* Modificare i risultati e le attività associate
* Attiva
* Disattivala
* Elimina
* Allinea a un altro obiettivo
* Convertire risultati o attività in altri obiettivi
* Aggiornalo
<!--
...
1. Fai clic sul menu **Altro** ![Icona Altro](assets/more-icon.png) a destra del nome dell&#39;obiettivo per modificare o condividere ulteriormente l&#39;obiettivo.
