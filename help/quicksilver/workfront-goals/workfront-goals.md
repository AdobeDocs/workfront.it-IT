---
title: 'Obiettivi di Adobe Workfront: indice degli articoli'
description: Gli obiettivi di Adobe Workfront consentono di definire, comunicare e raggiungere risultati strategici collegando la strategia all’esecuzione e alla consegna del lavoro. Consulta gli articoli delle sezioni seguenti per scoprire come impostare e gestire gli obiettivi all’interno della tua organizzazione e cosa li guida.
author: Alina
draft: Probably
...
Consulta gli articoli delle sezioni seguenti per scoprire come impostare e gestire gli obiettivi all’interno della tua organizzazione e per capire cosa li guida:

* [Panoramica sugli obiettivi di Adobe Workfront](../workfront-goals/goal-management/wf-goals-overview.md)
* [Gestione degli obiettivi in Adobe Workfront Goals: article index](../workfront-goals/goal-management/goal-management.md)
