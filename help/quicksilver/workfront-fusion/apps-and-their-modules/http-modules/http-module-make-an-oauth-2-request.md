...
>
>* [HTTP > Creare un modulo di richiesta OAuth 2.0](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-an-oauth-2-request.html)
>
...
* [Istruzioni per la creazione di una connessione a Google in HTTP >[!UICONTROL Rendi] un modulo di richiesta OAuth 2.0](#instructions-for-creating-a-connection-to-google-in-the-http-make-an-oauth-20-request-module)
...
1. Verifica di aver creato un progetto, configurato le impostazioni OAuth e generato le credenziali come descritto in [Connetti [!DNL Adobe Workfront Fusion] a [!DNL Google Services] utilizzando un client OAuth personalizzato](../../../workfront-fusion/connections/connect-fusion-to-google-using-oauth.md).
...
1. Immetti i seguenti valori:
   ...
   <table style="table-layout:auto">  
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL ID client] </td> 
      <td> <p>Immetti l'ID client [!DNL Google]. </p> <p>Per creare un ID client, vedere <a href="../../../workfront-fusion/connections/connect-fusion-to-google-using-oauth.md#create2" class="MCXref xref">Creare credenziali OAuth</a> in <a href="../../../workfront-fusion/connections/connect-fusion-to-google-using-oauth.md" class="MCXref xref">[!DNL Connect Adobe Workfront Fusion] a [!DNL Google Services] utilizzando un client OAuth personalizzato</a>.</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">[!UICONTROL Segreto client]</td> 
      <td> <p>Immetti il segreto client [!DNL Google]. </p> <p>Per creare un segreto client, vedere <a href="../../../workfront-fusion/connections/connect-fusion-to-google-using-oauth.md#create2" class="MCXref xref">Creare credenziali OAuth</a> in <a href="../../../workfront-fusion/connections/connect-fusion-to-google-using-oauth.md" class="MCXref xref">[!DNL Connect Adobe Workfront Fusion] per [!DNL Google] Servizi utilizzando un client OAuth personalizzato</a>.</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"> <p>[!UICONTROL Autorizza parametri]</p> </td> 
...
### Istruzioni per la connessione a [!DNL Microsoft Graph API] tramite [!UICONTROL HTTP] > [!UICONTROL Crea una richiesta OAuth 2.0]

Per istruzioni relative a [!DNL Microsoft Graph API], consulta [Chiamare il  [!DNL MS Graph REST API] tramite il [!DNL Adobe Workfront Fusion] [!UICONTROL HTTP] > [!UICONTROL Effettuare una richiesta OAuth 2.0] modulo](../../../workfront-fusion/connections/call-the-ms-graph-rest-api.md).
