...
title: Moduli Adobe Maestro
description: Con il [!DNL Adobe Maestro] moduli, è possibile avviare un [!DNL Adobe Workfront Fusion] scenario basato sugli eventi nel tuo [!DNL Adobe] Conto Maestro, crea, leggi o aggiorna contratti e altri record, cerca i record utilizzando i criteri impostati e carica i documenti.
author: Becky
...
# [!DNL Adobe Maestro] moduli

Con il [!DNL Adobe Maestro] moduli, puoi attivare uno scenario quando si verificano eventi in Maestro. Puoi anche creare, leggere, aggiornare ed eliminare record oppure eseguire una chiamata API personalizzata al tuo [!DNL Adobe Maestro] account.
...
## Creare una connessione a [!DNL Adobe Maestro]

Puoi creare una connessione al tuo [!DNL Maestro] account direttamente dall&#39;interno di un [!DNL Workfront Fusion] modulo.

1. In qualsiasi [!DNL Maestro] modulo app, fai clic su **[!UICONTROL Aggiungi]** accanto al [!UICONTROL Connessione] casella.
...
## [!DNL Adobe Maestro] moduli e relativi campi

### Guarda gli eventi

Questo modulo di attivazione avvia uno scenario quando un record, un tipo di record o un&#39;area di lavoro viene creata, aggiornata o eliminata in Maestro.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Per istruzioni sulla creazione di una connessione a [!DNL Adobe Maestro], vedi <a href="#create-a-connection-to-adobe-maestro" class="MCXref xref" >Creare una connessione a [!DNL Adobe Maestro]</a> in questo articolo.</td>
    </tr>
    <tr>
...
Questo modulo di azione elimina un singolo tipo di record in Maestro dal suo ID.

>[!WARNING]
>
>L&#39;eliminazione di un tipo di record in Maestro comporta anche l&#39;eliminazione di tutti i record nella tabella dei tipi di record.
...
Questo modulo effettua una chiamata API personalizzata al [!DNL Adobe Maestro] API.
...
Questa azione crea un singolo record in Maestro.
  ...
  <tbody>
    <tr>
     ...
     <tr>
      ...
      <td>Immettere o mappare il tipo di record che si desidera creare. I tipi di record disponibili si basano sul tuo account Maestro.</td> 
      </tr>
     <tr>
      <td role="rowheader">
        <p>Altri campi</p>
...
Questo modulo di azione elimina il record specificato in Maestro.
...
Questo modulo di azione recupera un singolo record da [!DNL Adobe Maestro], specificato dal relativo ID.
...
Questo modulo di azione recupera un elenco di tipi di record in un [!DNL Adobe Maestro] account.
...
Questa azione aggiorna un singolo record in Maestro.
  ...
  <tbody>
    <tr>
     ...
     <tr>
      ...
      <td>Immettere o mappare il tipo di record che si desidera aggiornare. I tipi di record disponibili si basano sul tuo account Maestro.</td> 
      </tr>
     <tr>
      <td role="rowheader">
        <p>Altri campi</p>
