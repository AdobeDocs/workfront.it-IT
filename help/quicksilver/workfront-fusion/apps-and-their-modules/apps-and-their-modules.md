...
title: App e loro moduli
description: Adobe Workfront Fusion offre attualmente connettori dedicati per le app elencate. Se l’app con cui desideri lavorare non è presente in questo elenco, puoi connetterti a utilizzando i moduli HTTP, SOAP o JSON.
author: Becky
...
>[!IMPORTANT]
>
>Adobe Workfront Fusion può connettersi a quasi tutti i servizi Web. Non è limitato solo alle app presenti in questo elenco. Se l&#39;app con cui vuoi lavorare non è presente in questo elenco, puoi utilizzare i seguenti moduli per connetterti direttamente al servizio Web:
>
...
* [[!UICONTROL Crittografatore]](../../workfront-fusion/apps-and-their-modules/encryptor-modules.md)
...
* [[!DNL Intacct] moduli](../../workfront-fusion/apps-and-their-modules/intacct-modules.md)
...
* [[!UICONTROL Analizzatore di testo]](../../workfront-fusion/apps-and-their-modules/text-parser.md)
