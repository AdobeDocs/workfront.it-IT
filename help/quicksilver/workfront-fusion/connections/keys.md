...
Se un modulo richiede una chiave pubblica o privata, puoi aggiungerla al portachiavi. Per ulteriori informazioni, vedere [Configurare le impostazioni di un modulo in [!DNL Adobe Workfront Fusion]](../../workfront-fusion/modules/configure-a-modules-settings.md).


Per ulteriori informazioni sulle chiavi pubbliche e private, vedere [Termini di base in [!DNL Adobe Workfront Fusion]](../../workfront-fusion/get-started/basic-terms.md).
