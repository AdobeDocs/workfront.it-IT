...
title: Creare una connessione a [!DNL Adobe Workfront Fusion] - Istruzioni di base
description: Molti [!DNL Adobe Workfront Fusion] I connettori non richiedono una configurazione personalizzata durante la creazione di una connessione. Questo articolo descrive il processo predefinito di creazione della connessione.
author: Becky
...
1. Clic **[!UICONTROL Aggiungi]** accanto al [!UICONTROL Connessione] per aprire la **[!UICONTROL Creare una connessione]** pannello.
