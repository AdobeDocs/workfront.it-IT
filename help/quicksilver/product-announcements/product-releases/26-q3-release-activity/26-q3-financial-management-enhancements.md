---
title: Miglioramenti di Financial Management per il terzo trimestre 2026
description: Miglioramenti di Financial Management per il terzo trimestre 2026
author: Becky
...
## Aggiungere una scheda tariffa a un modello
...
Per informazioni, vedere [Allegare una scheda tariffaria a un modello](/help/quicksilver/manage-work/projects/create-and-manage-templates/attach-rate-card-to-template.md).

## Aggiungere tariffe di fatturazione tra le tariffe esistenti in una scheda tariffa
...
In precedenza era possibile aggiungere solo le tariffe in fondo all’elenco.

Per informazioni, consulta [Gestire le schede tariffarie](/help/quicksilver/administration-and-setup/manage-enterprise-operations/manage-rate-cards.md).

## Gli attributi della tariffa non possono essere modificati una volta utilizzati sulle tariffe
