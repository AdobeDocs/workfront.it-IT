...
Sono stati apportati i seguenti miglioramenti alle integrazioni Workfront per Experience Manager Assets e Assets Essentials:

* L’integrazione ora supporta GCP come provider di servizi cloud. AWS e Azure erano precedentemente supportati. Per ulteriori informazioni, vedere [Panoramica delle integrazioni Adobe Experience Manager Assets](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/aem-asset-integrations.md).

* Il limite di dimensione per i file inviati ad Experience Manager tramite l’integrazione è aumentato a 30 GB. In precedenza, il limite era di 5 GB. Per ulteriori informazioni, consulta [Inviare un documento a Experience Manager Assets o Assets Essentials](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/send-to-aem.md).
