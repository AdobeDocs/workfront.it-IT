...
| ----------------- | ----------------- |
| <ul><li>25.2 (febbraio 2025)</li><li>25.3 (marzo 2025)</li><li>25.4 (aprile 2025)</li></ul> | <ul><li>25.4 (aprile 2025)</li></ul> |
...
<tbody>
    <tr>
        <td>
            ...
            <p>Nei campi personalizzati calcolati di Workfront sono ora disponibili le seguenti espressioni: ARRAY, FORMAT, SWITCH, SORTASCARRAY, SORTDESCARRAY, ARRAYLENGTH, ARRAYELEMENT e ADDHOUR. Le definizioni e gli esempi di ciascuna espressione sono disponibili nell’editor di calcolo e su Experience League.</p>
        </td>
        <td>
