...
Per ulteriori informazioni sulla creazione di profili di schede orario, vedi [Creare, modificare e assegnare profili di schede orario](../../../../timesheets/create-and-manage-timesheets/create-timesheet-profiles.md).
