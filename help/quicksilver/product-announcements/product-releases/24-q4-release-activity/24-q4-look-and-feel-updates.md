...
## Aggiornamenti look-and-feel dei rapporti
...
L’interfaccia delle dashboard è stata aggiornata per corrispondere al design di altre aree di Workfront. Questi aggiornamenti includono modifiche aggiuntive alle funzioni del dashboard:

* È stata migliorata la schermata di anteprima di stampa durante la stampa di un dashboard. Per informazioni sulla stampa di un dashboard, vedere [Stampare un dashboard](/help/quicksilver/reports-and-dashboards/dashboards/creating-and-managing-dashboards/print-dashboard.md).
* Sono state rimosse le schede Tutto, Rapporti e Calendari in Rapporti e calendari disponibili dall’editor del dashboard. Per ulteriori informazioni sull&#39;aggiunta di report e calendari a un dashboard, vedere [Modificare un dashboard](/help/quicksilver/reports-and-dashboards/dashboards/creating-and-managing-dashboards/edit-dashboard.md).
...
## Aggiornamenti look-and-feel per viste, raggruppamenti e filtri legacy negli elenchi
