...
**Versione di anteprima: 16 ottobre 2025; versione di produzione per tutti i clienti: a partire dalla settimana del 23 ottobre 2025**

Le caselle Nuovo e Modifica rischi sono state aggiornate quando si crea o si aggiorna un rischio esistente. Il nuovo design ora si adatta ad altre aree di Workfront.  Per accedere alla nuova progettazione, crea un rapporto sui rischi e inseriscilo in un dashboard, quindi aggiungi il dashboard a un progetto e gestisci i rischi dal dashboard.

Per informazioni, consulta [Creare e modificare i rischi nei progetti](/help/quicksilver/manage-work/projects/define-a-business-case/create-edit-risks-on-projects.md).
...
Per visualizzare queste modifiche, vai al tuo profilo utente e fai clic su **Indisponibilità** nel pannello a sinistra.

Per ulteriori informazioni, vedere [Configurare l&#39;indisponibilità personale](/help/quicksilver/workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/personal-time-overview.md) e [Delegare la richiesta di approvazione](/help/quicksilver/review-and-approve-work/manage-approvals/delegate-approval-requests.md).

## Aggiornamenti dell’interfaccia effettuati nel quarto trimestre

## Amministrazione e configurazione

+++Espandi per visualizzare gli aggiornamenti dell’interfaccia di amministrazione e configurazione effettuati nel quarto trimestre
...
**Versione di anteprima: 25 settembre 2025; versione di produzione: a partire dalla settimana del 23 ottobre 2025**

La pagina Gravità è stata aggiornata con un design più moderno, coerente con le altre aree di Workfront.

Una modifica visibile nell&#39;interfaccia consiste nel fatto che per impostare una gravità come predefinita o per eliminarla, è necessario selezionare la casella di controllo accanto al nome della gravità e scegliere un&#39;opzione dalla barra delle azioni nella parte inferiore dello schermo.

Per visualizzare queste modifiche, vai a Configurazione > Preferenze progetto > Gravità.

Per ulteriori informazioni, vedere [Creare o personalizzare le gravità dei problemi](/help/quicksilver/administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/create-customize-issue-severities.md).
...
Una modifica visibile nell’interfaccia consiste nel fatto che, per impostare una priorità come predefinita o per eliminarla, è necessario selezionare la casella di controllo accanto al nome della priorità e scegliere un’opzione dalla barra delle azioni nella parte inferiore dello schermo.

Per visualizzare queste modifiche, vai a Configurazione > Preferenze progetto > Priorità.

Per ulteriori informazioni, vedere [Creare e personalizzare le priorità](/help/quicksilver/administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/create-customize-priorities.md).
...
È stato aggiornato l’aspetto delle caselle Nuovo e Modifica tipo di ora durante l’aggiunta o la modifica dei tipi di ora nell’area Tipi di ora della configurazione. L’area Tipi di ore viene visualizzata sotto l’area Scheda orario e ore di Configurazione. Le caselle Nuovo e Modifica tipo di ora ora corrispondono ad altre aree di Workfront.
...
Il pulsante di esportazione è stato spostato sul lato destro della pagina.
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia Portfolio effettuati nel quarto trimestre
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia del programma effettuati nel quarto trimestre
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia del progetto effettuati nel quarto trimestre
...
>[!NOTE]
>
>Questo elemento è stato temporaneamente rimosso sia dall’anteprima che dalla produzione e aggiunto nuovamente il 21 agosto 2025.
...
### Aggiornamenti dell’interfaccia alla casella Nuovi argomenti coda di progetti e modelli
...
Con questo aggiornamento è stata introdotta una piccola modifica della funzionalità. Ora, quando si fa clic su un Argomento coda, si viene indirizzati direttamente alla pagina di modifica dell&#39;Argomento coda, anziché alla pagina Dettagli argomento coda.
...
* Sezione Persone di un modello
* La sezione Persone di un progetto
* La sezione Membri società di una società
...
È stata aggiornata la finestra di dialogo per l’aggiunta di una nuova spesa a un progetto, in modo che corrisponda ad altre aree dell’applicazione. La finestra di dialogo aggiornata è disponibile quando si aggiungono le spese in progetti o modelli.
...
+++Espandi per visualizzare gli aggiornamenti all’interfaccia Modelli effettuati nel quarto trimestre

### Aggiornamenti dell’interfaccia per l’elenco Persone in un modello

**Versione di anteprima: 21 agosto 2025; versione di produzione: 28 agosto 2025**

È stato aggiornato l’aspetto dell’elenco Persone in un modello, per uniformarlo al design di altre aree di Workfront.

Lavorare con le persone su un modello è simile a lavorare con le persone su un progetto. Per informazioni, vedere [Gestione del team di progetto](/help/quicksilver/manage-work/projects/planning-a-project/manage-project-team.md).
...
Abbiamo aggiornato l’aspetto dei seguenti elenchi sui modelli:
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia utente effettuati nel quarto trimestre
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia di amministrazione e configurazione effettuati nel terzo trimestre
...
**Anteprima: 10 luglio 2025; produzione per tutti: 17 luglio 2025**
...
**Anteprima versione: 19 giugno 2025; produzione versione: 19 giugno 2025**
...
### Aggiornamenti dell&#39;interfaccia per l&#39;elenco Tipi di spesa

**Versione di anteprima: 22 maggio 2025; versione di produzione per tutti i clienti: 29 maggio 2025**

Abbiamo aggiornato l’aspetto dell’elenco Tipi di spesa nell’area Configura, in modo che corrisponda al design di altre aree di Workfront.

È stata applicata una piccola modifica alla funzionalità dell’elenco Tipi di spesa. Per modificare o eliminare un tipo di spesa, selezionarlo nell&#39;elenco e fare clic sull&#39;icona appropriata. Non è possibile modificare o eliminare i tipi di spesa predefiniti.
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia Documenti effettuati nel terzo trimestre
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia di navigazione e ricerca effettuati nel terzo trimestre
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia Progetti effettuati nel terzo trimestre
...
+++Espandi per visualizzare gli aggiornamenti all’interfaccia Reports and Dashboards effettuati nel terzo trimestre
...
+++Espandi per visualizzare gli aggiornamenti dell’interfaccia utente effettuati nel terzo trimestre

### Aggiornamenti dell’interfaccia all’organigramma
...
### Aggiornamenti dell’interfaccia a un elenco Percorso Milestone in Configurazione
...
Per visualizzare questa modifica, vai all’icona Notifiche nell’angolo in alto a destra, quindi scegli Tutte le notifiche.
...
Invece di fare clic direttamente sul nome del modello per modificarlo, seleziona la casella di controllo e fai clic sull’icona Modifica nella barra degli strumenti.
...
**Versione di anteprima: 23 gennaio 2025; versione di produzione: a partire dalla settimana del 3 febbraio 2025**
...
La finestra di dialogo di modifica Cartelle avanzate è stata aggiornata con un design più moderno che è coerente con altre aree di Workfront.
...
Per creare un rapporto Team, vai a Rapporti > Nuovo rapporto > Livello di accesso.
