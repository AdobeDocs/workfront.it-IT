...
<span class="preview">Le funzioni Off-cycle (quelle rilasciate alla produzione prima della data di rilascio del primo trimestre 2025) sono evidenziate in giallo.</span>
...
* [Miglioramenti del flusso di aggiornamento](#update-stream-enhancements)
...
<tbody>
    <tr>
        <td>
            <p><span class="bold">Funzione</span></p>
        </td>
        <td>
    ...
    <tr>
        <td>
           ...
           [!BADGE In Produzione ]{type=Informative}
            <p>È ora possibile creare regole business e applicare la convalida a questi oggetti aggiuntivi: Società, Iterazione, Categoria risorsa non manodopera, Ruolo mansione, Utente, Assegnazione, Pool di risorse, Ora di fine, Documento e Ora.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
                <li>Rilascio in anteprima: mercoledì 16 gennaio 2024</li>
                <li>Rilascio per produzione per tutti i clienti: con la versione 25.1 (16 gennaio 2025)</li>
            </ul>
        </td>
    </tr>
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md" class="MCXref xref" xrefformat="{para}">
           Confronto di oggetti tra ambienti diversi per la promozione dell'ambiente</a></p>
           [!BADGE In Produzione ]{type=Informative}
            <p>Per semplificare la determinazione degli oggetti da includere in un pacchetto di promozione dell'ambiente, abbiamo aggiunto la possibilità di confrontare gli oggetti tra ambienti diversi. Puoi quindi aggiungere oggetti a un pacchetto direttamente da questo confronto.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Più oggetti disponibili per la promozione dell'ambiente</a></p>
            [!BADGE In Produzione ]{type=Informative}
    ...
    <tr>
        <td>
            ...
            [!BADGE In Produzione ]{type=Informative}
            <p>In qualità di amministratore di sistema o di gruppo, è ora disponibile una nuova preferenza che indica se Workfront deve utilizzare la pianificazione del progetto o dell'utente per calcolare la cronologia del progetto quando si assegna un utente a un'attività e sia il progetto che l'utente sono associati a una pianificazione.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
    ...
    <tr>
        <td>
            ...
            [!BADGE In Produzione ]{type=Informative}
            <p>È ora possibile includere collegamenti ipertestuali nel messaggio di errore personalizzato di una regola business, per guidare l'utente su come modificare la propria azione all'interno del vincolo della regola. L’URL statico può collegarsi alla documentazione o ad altre pagine utili per l’utente.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
    ...
    <tr>
        <td>
            ...
            [!BADGE In Produzione ]{type=Informative}
            <p>Quando un modulo personalizzato contiene più sezioni con molti campi, può risultare difficile spostare un campo da una sezione a un’altra mediante trascinamento. A ciascun campo è stata aggiunta l’icona "sposta in", che consente di selezionare la sezione in cui è inserito il campo.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            Cambiare il proprietario di una bacheca</a></p>
            [!BADGE In Produzione ]{type=Informative}
            <p>Per impostazione predefinita, il creatore di una bacheca è il proprietario. Il proprietario della bacheca è l’unica persona in grado di eliminare quella bacheca o di aggiornarne i filtri nel pannello Configura.</p>
            <p>È stata aggiunta una funzionalità che consente agli amministratori di sistema di Workfront di cambiare il proprietario di una scheda. L’attuale proprietario di una bacheca può anche cambiare il proprietario di quella bacheca specifica. Questa funzionalità è disponibile su schede di base, retrospettive e kanban, ma non su schede dinamiche.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            <ul>
                ...
                <li>Mostra attività scadute questa settimana</li>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Aggiornarsi sul lavoro in Priorità</a></p>
            [!BADGE In produzione ]{type=Informative}
    ...
    <tr>
        <td>
            ...
            [!BADGE In Produzione ]{type=Informative}
            <p>È ora possibile interagire con documenti e bozze per attività e problemi nell'elenco lavori e nel calendario. Nella scheda Nuovi documenti è possibile</p>
            <ul>
                <li>Caricare un documento</li>
                <li>Crea una prova</li>
                <li>Avvia il visualizzatore delle prove</li>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Visualizzazione Calendario ora disponibile in Priorità</a></p>
            [!BADGE In Produzione ]{type=Informative}
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li><span class="preview">Rilascio per produzione per tutti i clienti: 14 novembre 2024</span></li>
            </ul>
        </td>
    </tr>
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Visualizza dettagli progetto in Priorità</a></p>
            [!BADGE In Produzione ]{type=Informative}
            <p>È ora possibile visualizzare i dettagli e i commenti del progetto dall'elenco lavori in Priorità.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            [!BADGE In Produzione ]{type=Informative}
            <p>Una funzionalità presente nell’ambiente di anteprima da dicembre 2023 e nell’ambiente di produzione a rilascio rapido da marzo 2024 è stata ora rimossa. Le funzioni hanno aggiunto suggerimenti più pertinenti sull'assegnazione intelligente durante l'assegnazione delle attività.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
...
<tr>
    ...
    <tr>
        <td>
            ...
            Aggiornamento del visualizzatore di correzione per il desktop</a></p>
            [!BADGE In Produzione ]{type=Informative}
        ...
        <td>
            ...
            <ul>
                ...
                <li><span class="preview">Rilascio per produzione per tutti i clienti: 9 gennaio 2025</span></li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-proofing-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Nuova estensione del browser per la revisione interattiva disponibile nella versione beta</a></p>
            [!BADGE In Produzione ]{type=Informative}
...
<tbody>
    ...
    <tr>
        <td>
            ...
            [!BADGE In Produzione ]{type=Informative}
            <p>Agli amministratori che accedono a Data Connect per la prima volta viene ora offerta l’opzione di creare un nuovo account Snowflake Reader facendo clic su un singolo pulsante. Il processo richiede alcuni minuti, ma non richiede ulteriori azioni.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
...
### Miglioramenti del flusso di aggiornamento
...
<tbody>
    ...
    <tr>
        <td>
            ...
            Esperienza di commento aggiornata nel widget Menzioni nell’area Home e I miei aggiornamenti</a></p>
            <p>Stiamo aggiornando l’esperienza relativa ai commenti nel widget Menzioni in Home e nella sezione Menzioni nell’area I miei aggiornamenti. La stessa esperienza nell’area Aggiornamenti della maggior parte degli oggetti Workfront è ora disponibile anche nel widget Menzioni e nella sezione Menzioni di Aggiornamenti personali.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
                <li>Rilascio in anteprima: venerdì 19 dicembre 2024</li>
                <li>Rilascio per produzione per tutti i clienti per Home: da annunciare</li>
                <li>Rilascio per produzione per tutti i clienti per I miei aggiornamenti: 19 giugno 2025</li>
            </ul>
        </td>
    </tr>
</tbody>
...
<tbody>
    <tr>
        <td>
            ...
            Aggiornamento sulla gestione delle risorse spostate o eliminate nelle cartelle collegate</a></p>
            [!BADGE In Produzione ]{type=Informative}
            <p>Abbiamo modificato il modo in cui vengono gestite le risorse spostate ed eliminate quando si utilizza l'integrazione di Adobe Workfront con Experience Manager Assets e Assets Essentials:</p>
            <ul>
                <li>Risorse eliminate: quando una risorsa viene eliminata all'interno di una cartella collegata in Risorse o Assets Essentials, la risorsa eliminata viene mantenuta nell'area Documenti progetto.</li>
                <li>Risorse spostate: quando una risorsa viene spostata all’esterno di una cartella collegata in Assets o Assets Essentials, la risorsa spostata verrà mantenuta nell’area Documenti progetti.</li>
            </ul>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
                <li>Rilascio in anteprima: venerdì 21 novembre 2024</li>
                <li><span class="preview">Rilascio per produzione per tutti i clienti: 5 dicembre 2024</span></li>
            </ul>
        </td>
    </tr>
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Le sezioni all’interno di un modulo personalizzato sono ora comprimibili ed espandibili</a></p>
            [!BADGE In Produzione ]{type=Informative}
            <p>Quando a un oggetto è associato un modulo personalizzato con più sezioni, è ora possibile comprimere ed espandere tutte le sezioni, ad eccezione della sezione predefinita nella parte superiore del modulo. L'amministratore può inoltre visualizzare questa funzionalità durante l'anteprima del modulo nella finestra di progettazione del modulo.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Assistente AI ora può lavorare con progetti, attività e problemi</a></p>
            [!BADGE In Produzione ]{type=Informative}
            <p>Per semplificare la gestione degli elementi di lavoro in Workfront, abbiamo aggiornato l'Assistente all'intelligenza artificiale per lavorare con progetti, attività e problemi. L'Assistente AI ora è in grado di individuare progetti, attività e problemi in base ai criteri specificati.</p>
        </td>
        <td>
            <p><b>Disponibile in queste date:</b></p>
            <ul>
...
Le nuove funzioni di Workfront Fusion sono disponibili in produzione a una cadenza che esula dalla pianificazione del rilascio del primo trimestre 2025. Per ulteriori informazioni sulle funzioni più recenti, consulta [Attività di rilascio di Adobe Workfront Fusion](https://experienceleague.adobe.com/it/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity).

### Miglioramenti di Pianificazione di Workfront

Nuove funzioni di Pianificazione di Workfront sono disponibili nell’ambiente di Produzione. Per ulteriori informazioni sulle funzioni più recenti, vedere [Attività sulla versione di Adobe Workfront Planning First Quarter 2025](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q1.md).
