...
Abbiamo modificato il modo in cui le risorse spostate ed eliminate vengono gestite quando si utilizza l’integrazione di Adobe Workfront con Experience Manager Assets e Assets Essentials:

* Risorse eliminate: quando una risorsa viene eliminata all’interno di una cartella collegata in Assets o Assets Essentials, la risorsa eliminata viene mantenuta nell’area Documenti progetto.
