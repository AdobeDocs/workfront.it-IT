...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Accesso di visualizzazione o superiore all'oggetto in cui si desidera caricare un documento.</p></td> 
  </tr> 
 </tbody> 
</table>
...
* È necessario installare il plug-in [!DNL Adobe Workfront for design and video] prima di caricare i documenti da [!DNL InDesign].
...
## Carica documenti in [!DNL InDesign]
