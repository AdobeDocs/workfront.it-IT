...
>* L&#39;elenco delle richieste nell&#39;area Richieste utilizza l&#39;elenco avanzato di Workfront. Per ulteriori informazioni, vedere [Usa elenchi avanzati](/help/quicksilver/workfront-basics/navigate-workfront/use-lists/enhanced-lists.md).
...
<p>Qualsiasi licenza di Workfront Planning, per visualizzare le richieste di Workfront Planning negli elenchi delle richieste</p>
  ...
  <tr> 
   ...
   <td> <p>Modifica accesso a Problemi</p>  <p>Per aggiungere visualizzazioni ai modelli di layout è necessario essere un amministratore Workfront</td> 
  </tr> 
  <!--
  <tr> 
...
1. Fai clic sul menu a discesa **Visualizzazioni** ![Visualizzazioni](assets/view-icon-requests.png) e fai clic sul menu a tre punti accanto alla visualizzazione, seleziona **Rinomina**, quindi digita il nuovo nome della visualizzazione.
...
1. (Facoltativo) Fare clic su **Colonne** per aprire la casella F **rende visibilità e ordine**.
1. Attivare l&#39;impostazione per ogni campo che si desidera visualizzare nell&#39;elenco, disattivarla per nasconderla oppure trascinare i campi in un ordine diverso.

1. (Facoltativo) Fare clic su **Filtri** e iniziare ad aggiungere le condizioni per le richieste che si desidera visualizzare.
   ...
   * **Inserito da**: nome dell&#39;utente che ha aggiunto la richiesta. Se la richiesta è stata aggiunta da un utente esterno a Workfront, nel campo **Inserito da** verrà visualizzato `N/A`.
...
1. Per accedere a un elenco di richieste in Richieste:

   {{step1-to-requests}}

1. Assicurati che l&#39;impostazione **Usa nuova esperienza** sia attivata.
1. Nell&#39;elenco **Richieste** individuare la visualizzazione che si desidera condividere.
1. Passa il mouse sulla vista che desideri condividere, quindi fai clic sul menu con i tre punti a destra del nome della vista, quindi fai clic su **Condividi**.
1. Nella casella **Condividi**, immetti le persone, i team, i ruoli, i gruppi o le società con cui desideri condividere la visualizzazione, quindi selezionali dall&#39;elenco quando vengono visualizzati.
1. Fai clic su **Salva**.
