...
1. Modifica i dettagli del progetto facendo clic sul menu **Altro** a destra del nome del progetto, nell&#39;intestazione, quindi **Modifica** ![Icona Modifica](assets/qs-edit-icon.png) accanto al nome del progetto.
