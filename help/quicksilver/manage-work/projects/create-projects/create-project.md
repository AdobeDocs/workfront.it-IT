...
1. Modificare i dettagli del progetto facendo clic sul menu **Altro** e quindi sull&#39;icona **Modifica** ![Modifica](assets/qs-edit-icon.png) accanto al nome del progetto.
