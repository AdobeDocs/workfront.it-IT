...
Il beneficio pianificato non è calcolato da Adobe Workfront. In qualità di proprietario del progetto, puoi specificare manualmente il beneficio pianificato di un progetto quando lo modifichi. È consigliabile che ogni organizzazione stabilisca un criterio per la determinazione di questo valore.
...
* Nel Business Case Summary. Non è possibile modificare il Vantaggio pianificato di un progetto nel Riepilogo del Business Case.
...
* In un report di progetto, quando si aggiunge la colonna Benefit pianificato alla visualizzazione del report. È possibile modificare il beneficio pianificato di un progetto in un report di progetto.\
...
* In Portfolio Optimizer. Non è possibile modificare il Vantaggio pianificato di un progetto in Portfolio Optimizer.\
...
1. Fai clic su **Dettagli progetto** nel pannello a sinistra, oppure fai clic sull&#39;icona **Altro** ![](assets/qs-more-icon-on-an-object.png) a destra del nome del progetto, quindi fai clic su **Modifica**.
1. Specifica l&#39;importo del benefit pianificato nel campo **Benefit pianificato**.
1. (Condizionale) A seconda dell&#39;area del progetto selezionata, fare clic su **Salva modifiche** o **Salva**.
