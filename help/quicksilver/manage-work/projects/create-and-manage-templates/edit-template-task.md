...
La modifica delle attività dei modelli varia a seconda dell’ambiente scelto per la modifica delle attività.

### Modificare le attività modello nell’ambiente di produzione

>[!NOTE]
>
><span class="preview">Alcuni clienti possono modificare le attività modello nei propri ambienti di produzione nello stesso modo in cui le modificano nel proprio ambiente di anteprima.</span>
>
><span class="preview">Per informazioni sulla modifica delle attività nell&#39;ambiente di anteprima, vedere la sezione [Modificare le attività modello nell&#39;ambiente di anteprima](#edit-template-tasks-in-the-preview-environment) in questo articolo. </span>
...
### Modificare le attività dei modelli nell’ambiente di anteprima
...
1. (Condizionale) Per modificare tutte le informazioni su un&#39;attività modello o su più attività contemporaneamente, fai clic su per selezionarle da un elenco, quindi fai clic sull&#39;icona **Modifica** ![Icona Modifica](assets/edit-icon.png) nella parte superiore dell&#39;elenco.
...
* [Nome attività modello](#template-task-name)
* [Panoramica](#overview-2)
* [Assegnazioni](#assignments-2)
* [Finanz](#finance-2)
...
1. Fai clic su **Assegnazioni** nel pannello a sinistra.
   ...
   ![Assegnazioni sulle attività modello](assets/assignments-edit-template-tasks-box.png)
...
1. Aggiorna le seguenti informazioni:
   ...
   <p><b>IMPORTANTE</b></p>
   <p>Poiché la durata dell'attività corrisponde in genere al tempo che intercorre tra l'inizio pianificato e le date di completamento pianificate, influisce sulla sequenza temporale del progetto.</p> 
