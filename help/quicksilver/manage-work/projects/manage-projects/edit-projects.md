...
La modifica di un progetto consente di modificare le informazioni e le impostazioni del progetto, nonché le attività e i problemi relativi al progetto.
...
1. Fai clic sul pulsante **Aggiungi modulo personalizzato** selezionare un modulo dall’elenco per allegarlo al progetto.
...
1. (Condizionale) Se hai allegato un modulo personalizzato al progetto, modifica tutti i campi del modulo. È necessario specificare tutti i campi obbligatori prima di salvare il progetto.
   ...
   >[!NOTE]
   >
   >A seconda di come l’amministratore di Workfront ha impostato le autorizzazioni per le sezioni del modulo personalizzato, non tutti possono visualizzare o modificare gli stessi campi in un determinato modulo personalizzato. Le autorizzazioni per modificare i campi all’interno di una sezione di un modulo personalizzato dipendono dalle autorizzazioni disponibili per il progetto stesso. Per informazioni sull’impostazione delle autorizzazioni per le sezioni di un modulo personalizzato, vedere [Creare o modificare un modulo personalizzato](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md). Per informazioni sull&#39;impostazione delle autorizzazioni sui progetti, vedi [Condivisione di un progetto in Adobe Workfront](../../../workfront-basics/grant-and-request-access-to-objects/share-a-project.md).
...
Puoi modificare i progetti in blocco e aggiornare tutte le relative informazioni contemporaneamente.
...
1. Specifica le informazioni su tutti i progetti selezionati nelle sezioni seguenti:
   ...
   * **Commento**
   ...
   >[!NOTE]
   >
   >Le informazioni che si modificano su tutti i progetti selezionati sovrascriveranno le informazioni esistenti sui singoli progetti, ad eccezione della **Gestione risorse** campo . L’aggiunta di un nuovo gestore di risorse in modalità di modifica collettiva aggiunge tale manager a tutti i progetti selezionati. Se altri gestori di risorse sono associati ai progetti selezionati, rimarranno nei progetti oltre a quello aggiunto tramite la modifica collettiva.
