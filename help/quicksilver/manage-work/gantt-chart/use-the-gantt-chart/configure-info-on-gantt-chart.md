...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> </p> <p>Stato dell'avanzamento corrente di una determinata attività. </p> <p>Per informazioni più dettagliate su ogni tipo di [!UICONTROL Progress Status], vedere <a href="../../../manage-work/tasks/task-information/task-progress-status.md" class="MCXref xref">Panoramica sullo stato di avanzamento dell'attività </a>.</p> </td> 
  </tr> 
  <tr> 
