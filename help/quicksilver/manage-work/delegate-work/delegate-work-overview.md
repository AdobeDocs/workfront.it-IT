...
Per informazioni sulla delega delle approvazioni di progetti, attività, problemi e documenti, consulta [Delega richiesta di approvazione](../../review-and-approve-work/manage-approvals/delegate-approval-requests.md).

Per informazioni su come delegare attività e problemi, consulta [Delega attività e problemi](../../manage-work/delegate-work/how-to-delegate-work.md).

## Panoramica sul lavoro dei delegati

Quando deleghi attività e problemi, tieni presente quanto segue:

* Il tuo [!DNL Workfront] L&#39;amministratore del gruppo o deve abilitare le preferenze di Delega nel [!UICONTROL Configurazione] prima di poter delegare il lavoro ad altri.
...
* Puoi delegare attività e problemi solo da [!UICONTROL Home] area.
* Esistono eccezioni per i seguenti tipi di licenza:
   ...
   * I revisori possono delegare il lavoro ad altri. Non possono visualizzare gli elementi di lavoro nel [!UICONTROL Home] area. Possono visualizzare solo le approvazioni.
   * I richiedenti non possono delegare il lavoro ad altri. Non possono visualizzare gli elementi di lavoro nel [!UICONTROL Home] area
...
* Se un elemento di lavoro viene completato durante il periodo di delega, l’elemento rimane nell’area Home del delegato e dell’assegnatario per 2 settimane prima [!DNL Workfront] lo rimuove automaticamente.
...
* Le attività e i problemi delegati non vengono visualizzati negli strumenti di gestione delle risorse, come [!UICONTROL Bilanciatore dei carichi di lavoro] o [!UICONTROL Pianificazione risorse] per gli utenti delegati.
* È possibile visualizzare i nomi del lavoro delegato e dei delegati in diverse aree di [!DNL Workfront]. Per ulteriori informazioni, vedere la sezione &quot;Individuare le informazioni sui delegati e sui delegati&quot; nell&#39;articolo [Gestire la delega di attività e problemi](../delegate-work/how-to-delegate-work.md).
