...
# Gestire l’area di lavoro di GenStudio in Pianificazione di Adobe Workfront
...
>[!NOTE]
>
>Prima di gestire l&#39;area di lavoro di GenStudio, vedere l&#39;articolo [Introduzione all&#39;integrazione di Adobe Workfront Planning e Adobe GenStudio for Performance Marketing](/help/quicksilver/planning/planning-and-genstudio-integration/get-started-with-workfront-planning-and-genstudio-integration.md) per ulteriori informazioni.
>
...
1. Fai clic su **Condividi** nell&#39;angolo superiore destro per condividere l&#39;area di lavoro con altri.
   ...
   >[!NOTE]
   >
   >Esistono le seguenti limitazioni di condivisione:
   >
   >* Non è possibile rimuovere gli utenti di GenStudio dall’area di lavoro di GenStudio dopo averla condivisa con loro.
   >* Se un utente dispone delle autorizzazioni in GenStudio, non è possibile modificarne l&#39;accesso in Visualizzazione in Workfront Planning. Devono disporre almeno delle autorizzazioni Contribute nell&#39;area di lavoro GenStudio in Planning.
   >* Non è possibile disabilitare le autorizzazioni ereditate per i tipi di record di GenStudio nell&#39;area di lavoro di GenStudio.
...
1. Fai clic sul menu **Altro** ![Altro menu](assets/more-menu.png) a destra del nome di un tipo di record, quindi fai clic su una delle seguenti opzioni:
   ...
   * **Gestione automazioni** o <span preview="preview">**Automazioni**</span>
   ...
   * **Gestione moduli di richiesta** o <span class="preview">**Moduli di richiesta**</span>
   ...
   * **Regole di business**
     ...
     È possibile configurare le regole business di tipo record per definire le condizioni che devono essere soddisfatte prima che agli utenti sia consentito modificare o eliminare record di quel tipo.

     Per informazioni, vedere [Configurare le regole business di tipo record](/help/quicksilver/planning/architecture/configure-business-rules.md).
   </div>
...
1. Per condividere una visualizzazione o il tipo di record, eseguire le operazioni seguenti:
   ...
   * Fai clic su **Condividi** nell&#39;angolo superiore destro della pagina del tipo di record, quindi fai clic su una delle seguenti opzioni:
     ...
     * **Esporta la visualizzazione corrente**
       ...
       >[!NOTE]
       >
       >Non è possibile rimuovere gli utenti di GenStudio dai tipi di record nell&#39;area di lavoro di GenStudio dopo averli condivisi con tale area di lavoro o con i tipi di record.
