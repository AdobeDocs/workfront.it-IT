---
title: Attività sulla versione di Adobe Workfront Planning per il 2024
description: Le funzionalità di Adobe Workfront Planning sono attualmente disponibili per tutti i clienti. Per accedere a queste funzionalità è necessario acquistare una licenza Workfront Planning oltre a una licenza Workfront.
author: Alina
...
Vedere anche i seguenti articoli per ulteriori funzioni rilasciate per Workfront Planning:

* [Attività di Adobe Workfront Planning Release per il 2023](/help/quicksilver/planning/general/release-activity-archives-2023.md) per le funzionalità rilasciate durante la versione beta, durante il 2023.
* [Attività di rilascio di Adobe Workfront Planning: indice dell&#39;articolo](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md) per le funzionalità attualmente rilasciate in Workfront Planning, dopo che è stato reso disponibile il 28 agosto 2024.

## Timeline della versione di Workfront Planning

La tabella seguente mostra la timeline del rilascio di Workfront Planning, a partire dalla disponibilità della versione beta nel 2023:
...
## Settimana del 26 agosto 2024

### Disponibilità generale di Adobe Workfront Planning

Anteprima e versione di produzione: 28 agosto 2024

Workfront Planning è disponibile per tutti i clienti che hanno acquistato una licenza Workfront Planning, oltre alla licenza Workfront. Per ulteriori informazioni sull&#39;acquisto di Workfront Planning, contattare il rappresentante commerciale.

Per informazioni sulle funzionalità rilasciate dopo il 28 agosto 2024 in Workfront Planning, vedere [Attività di rilascio di Adobe Workfront Planning: indice articolo](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md).

### Workfront Planning è ora disponibile in Anteprima

Anteprima: 28 agosto 2024

Con il rilascio di Workfront Planning a disponibilità generale, le funzionalità di Workfront Planning sono ora incluse nell’ambiente di anteprima.

### Nuovi pacchetti Adobe Workfront Planning e limitazioni dell&#39;oggetto

Anteprima e produzione: 28 agosto 2024

Sono state implementate nuove limitazioni per gli oggetti di Workfront Planning, in base ai due pacchetti seguenti:
...
### Abilitare le notifiche di Workfront Planning per le richieste di accesso
...
### Definire il formato per i valori dei campi formula

Anteprima e produzione: 28 agosto 2024

In qualità di responsabile dell&#39;area di lavoro, ora puoi definire il formato dei valori visualizzati in un campo formula. Puoi scegliere tra i seguenti formati:
...
Per informazioni, vedere la sezione &quot;Formula&quot; dell&#39;articolo [Creare i campi](/help/quicksilver/planning/fields/create-fields.md).

### Indicatori di presenza in tempo reale in una visualizzazione record

Anteprima e produzione: 28 agosto 2024

Per comprendere quali informazioni vengono modificate da altri utenti quando si lavora in una visualizzazione, sono stati introdotti indicatori di presenza in tempo reale per quest&#39;area di pianificazione di Workfront.
...
Anteprima: 21 agosto 2024

Produzione: 28 agosto 2024

È ora possibile creare record inviando una richiesta a un modulo di richiesta associato a un tipo di record.

In questo aggiornamento sono incluse le seguenti funzionalità:
...
### È possibile fare riferimento ai record di Workfront Planning tramite un campo esterno
...
È disponibile una nuova opzione Impostazioni con cui è possibile personalizzare l&#39;aspetto delle barre dei record nella visualizzazione Calendario. È possibile effettuare le seguenti operazioni:

* Aggiornare la data e l’ora dei record

* Aggiornare lo stile della barra
...
### L&#39;Assistente AI è stato riabilitato per Workfront Planning

Produzione e anteprima: 28 agosto 2024

L&#39;Assistente di Workfront AI è stato riattivato per l&#39;area di pianificazione di Workfront.

Per ulteriori informazioni sull&#39;Assistente di Workfront Planning AI, vedere [Panoramica dell&#39;Assistente di Adobe Workfront Planning AI](/help/quicksilver/planning/general/planning-ai-assistant-overview.md).

### Funzionalità di reporting per Workfront Planning con il dashboard Canvas

Produzione e produzione: 28 agosto 2024

È ora possibile visualizzare le informazioni di Workfront Planning in un rapporto utilizzando Workfront Canvas Dashboard. Per informazioni, vedere [Introduzione alle dashboard di Canvas](/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-canvas-dashboards/get-started-canvas-dashboards.md).
