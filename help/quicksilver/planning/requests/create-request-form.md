...
* Non è possibile aggiungere moduli di richiesta a tipi di record globali nell&#39;area di lavoro secondaria.
...
Per creare un modulo di richiesta, è necessario completare le operazioni seguenti:

* Aggiungere un nuovo modulo e configurarne i campi e gli elementi di contenuto
...
1. Fai clic su **Nuovo modulo di richiesta** per aggiungere un nuovo modulo.

   Viene visualizzata la casella **Crea modulo di richiesta**.

1. Nella casella **Crea modulo di richiesta**, aggiorna il nome del modulo di richiesta. Per impostazione predefinita, il nome del modulo è **Modulo senza titolo**. <!--check this; you logged a bug to rename it to 'Untitled request form' but was it fixed?-->
...
1. Fai clic su **Crea**.
   ...
   Il generatore di moduli di richiesta per il tipo di record selezionato viene aperto nella scheda **Modulo**.
...
1. (Facoltativo) Fai clic sulla scheda **Elementi di contenuto** sul lato sinistro del modulo e aggiungi i seguenti elementi:
   ...
   * **Testo descrittivo**: aggiungere istruzioni per una nuova sezione, ad esempio.
   * **Interruzione di sezione**: area del modulo contenente diversi campi.

     >[!TIP]
     >
     >La creazione di un modulo di richiesta Planning è simile alla creazione di un modulo personalizzato Workfront. Per ulteriori informazioni, vedere [Creare un modulo personalizzato](/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form.md).

1. (Facoltativo) Fare clic su **Anteprima** per visualizzare la modalità di visualizzazione del modulo per gli altri utenti che lo utilizzeranno per inviare una richiesta.
1. Continuare con una delle operazioni seguenti:

   * [Configurare le impostazioni del modulo](#configure-form-settings) se si desidera configurare ulteriori dettagli per il modulo nell&#39;ambiente di produzione
   * [Pubblica modulo](#publish-form) se non desideri configurare ulteriori impostazioni.
...
1. Selezionare una delle opzioni seguenti:
   ...
   * **La richiesta è stata completata al momento della creazione dell&#39;oggetto richiesto**. La richiesta verrà completata al momento della creazione del record.
   * **La richiesta è stata completata quando l&#39;oggetto richiesto è stato completato**: questa operazione completerà la richiesta quando il record verrà contrassegnato come completato.
...
1. Dopo aver creato il modulo e averlo salvato, fai clic su **Pubblica** per pubblicare il modulo e ottenere un collegamento univoco.
   ...
   * Il pulsante **Annulla pubblicazione** sostituisce il pulsante **Pubblica**. Facendo clic su di esso, il modulo non sarà accessibile.
...
1. Fare clic sulla freccia rivolta a sinistra a sinistra del nome della maschera nell&#39;intestazione per chiudere la maschera.
   ...
   Viene aperto l&#39;elenco **Moduli di richiesta** e il modulo viene visualizzato nell&#39;elenco.

## Condivisione di un modulo di richiesta

1. Passare a un elenco di moduli di richiesta ed eseguire una delle operazioni seguenti:

   * Fai clic sul menu **Altro** ![Altro menu](assets/more-menu.png) a destra del nome del modulo di richiesta nella pagina del tipo di record.
   * Fare clic sul nome di un modulo di richiesta nell&#39;elenco per aprirlo.
...
1. Per condividere il modulo pubblicamente, seleziona la scheda **Condivisione pubblica**, quindi attiva l&#39;impostazione **Crea collegamento pubblico**. È disattivata per impostazione predefinita.
   ...
   >
   >     * Connessioni Workfront o Adobe Experience Manager
   >     * People
   >
...
1. (Condizionale) Se hai aperto il modulo, fai clic su **Salva** nell&#39;angolo inferiore destro della scheda **Modulo** per salvare il modulo.
...
1. (Facoltativo) Passa il puntatore del mouse sul nome di un modulo di richiesta nella visualizzazione elenco, quindi fai clic sul menu **Altro** ![Altro menu](assets/more-menu.png) a destra del nome del modulo e fai clic su una delle seguenti opzioni:
...
1. Fare clic sulla freccia rivolta a sinistra a sinistra di **Moduli di richiesta** nell&#39;intestazione per chiudere l&#39;elenco dei moduli di richiesta.
