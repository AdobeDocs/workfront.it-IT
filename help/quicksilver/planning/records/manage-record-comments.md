...
<p><b>NOTA</b></p>
   <p> Non tutti i clienti dispongono della licenza Collaboratore di Planning</p>
   </td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td>   <p>Visualizza o autorizzazioni superiori per un'area di lavoro, un tipo di record e un record</p>  
...
1. Fai clic su **Invia** per registrare il commento.
   ...
   Tutti coloro che dispongono delle autorizzazioni di visualizzazione per il tipo di record possono visualizzare un indicatore **Nuovo commento** nella vista tabella per il record a cui è stato aggiunto il commento.
