...
<span class="preview">La gestione della visualizzazione tabella varia a seconda dell&#39;ambiente da cui si accede. </span>

## Gestire la vista a tabella nell’ambiente di produzione
...
L’aggiunta di filtri nella vista a tabella nell’ambiente di anteprima è identica all’aggiunta di filtri nell’ambiente di produzione.

Per informazioni, vedere la sezione [Aggiungere filtri](#add-filters) in questo articolo.
...
L’abilitazione dell’indicatore di presenza in tempo reale nella vista a tabella nell’ambiente di anteprima è identica all’abilitazione nell’ambiente di produzione.

Per informazioni, vedere la sezione [Abilitare l&#39;indicatore di presenza in tempo reale](#enable-the-real-time-presence-indicator) in questo articolo.
