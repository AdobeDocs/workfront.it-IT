...
1. Per creare record nella vista timeline o modificare le date, effettuare una delle seguenti operazioni:
   ...
   * Trascinare i record per aggiornarne la posizione e le date nella sequenza temporale. Lo spostamento delle barre dei record ne aggiorna immediatamente le date di inizio e di fine.
   ...
   >[!TIP]
   >
   >Non è possibile ridimensionare e trascinare i record nella timeline per i tipi di oggetto Workfront e Adobe Experience Manager visualizzati nei raggruppamenti.
...
* <span class>È possibile filtrare i tipi di record nella visualizzazione timeline o qualsiasi tipo di record connesso che fa parte della struttura di suddivisione nella visualizzazione. </span>
...
1. Seleziona una visualizzazione timeline, quindi fai clic su **Filtri** nell&#39;angolo superiore sinistro della tabella.
1. <span class>(Condizionale)Se hai aggiunto una struttura di suddivisione alla visualizzazione timeline, espandi il tipo di record nel primo elenco a discesa nella casella del filtro. Si tratta del tipo di record di cui si sta visualizzando la vista timeline. </span>
...
1. Nell&#39;area **Layout** della casella **Raggruppa record per** selezionare una delle opzioni seguenti:
   ...
   * **Corsia**: i raggruppamenti vengono visualizzati con un pannello bloccato a sinistra in cui sono elencati gli elementi raggruppati e i raggruppamenti rientrano nella larghezza della visualizzazione della sequenza temporale.
