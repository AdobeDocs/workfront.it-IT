...
Le seguenti modifiche sono state apportate per le sottoscrizioni di eventi versione 2
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Viene inviato solo un evento <code>CREATE</code> contenente i valori dei parametri, inclusi i campi calcolati.</p> </td> 
   <td> <p>Se si dispone di un filtro per <code>UPDATE</code> eventi con valori di parametro (inclusi campi personalizzati calcolati) e si prevede di riceverlo dopo un evento <code>CREATE</code> dell'oggetto che include valori di parametro, l'evento <code>UPDATE</code> non verrà più ricevuto. Se si desidera visualizzare i valori dei parametri durante la creazione dell'oggetto, è necessario creare una sottoscrizione <code>CREATE</code> aggiuntiva.</p> </td> 
  </tr> 
  <tr> 
