      ...
      <td>
        <ul>
          <li>
            ...
            <p>Questa azione restituisce un valore booleano che indica se il cliente ha disabilitato l’opzione di aggiornamento automatico dei titolari di licenze di Contributer.</p>
         </li>
        </ul>
      </td>
    </tr>  </tbody>
