...
* Annunci sui prodotti {#product-announcements}
   ...
   * Rilasci di prodotti {#product-releases}
      ...
      * Versione Q4 2023 {#release-23-q4}
         ...
         * [Q4 2023 - Settimana di rilascio del 24 luglio 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-july-26.md)
         * [Q4 2023 - Settimana di rilascio del 31 luglio 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-july-31.md)
         * [Q4 2023 Settimana di rilascio del 14 agosto 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-aug-14.md)
         * [Q4 2023 Settimana di rilascio del 21 agosto 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-aug-21.md)
         * [Q4 2023 Settimana di rilascio dell’11 settembre 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-sept-11.md)
         * [Q4 2023 Settimana di rilascio del 2 ottobre 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-oct-2.md)
      ...
      * Archivio rilascio trimestrale {#quarterly-release}
         ...
         * Versione 2017.3 {#release-17-3}
            ...
            * [Attività versione finale beta 2017.3](product-announcements/product-releases/quarterly-release-archive/2017.3-release-activity/2017.3-beta-final-release-activity.md)
   ...
   * Notifiche {#announcements}
      ...
      * Archivio notifiche {#announcement-archive}
         ...
         * [I clienti dei cluster 1, 2 e 3 devono aggiornare eventuali blocchi IP di inserire nell&#39;elenco Consentiti per evitare il blocco dei servizi di Adobe Workfront. L’aggiornamento di tali blocchi deve essere eseguito in modo da evitare il blocco dei servizi di.](product-announcements/announcements/announcement-archive/clusters-1-3-update-whitelist.md)
...
* Amministrazione e configurazione {#administration-and-setup}
   ...
   * Introduzione all’amministrazione {#get-started-administration}
      ...
      * [Gestione delle licenze](administration-and-setup/get-started-wf-administration/manage-available-licenses-in-your-system.md)
      ...
      * Moduli personalizzati {#custom-forms}
         ...
         * Generatore di moduli personalizzati legacy {#custom-form-builder}
            * Utilizzare il sistema di creazione di moduli personalizzati {#use-the-custom-form-builder}
               * [Utilizzare il generatore di moduli personalizzati legacy](administration-and-setup/customize-workfront/create-manage-custom-forms/use-the-custom-form-builder.md)
               ...
               * [Aggiungere un campo personalizzato](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-custom-field-to-a-custom-form.md)
               ...
               * [Aggiungere un’interruzione di sezione con il generatore legacy](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-section-break-to-a-custom-form.md)
               ...
               * [Condivisione di campi personalizzati e widget con il generatore legacy](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
               * [Riutilizzare un campo personalizzato o un widget con il generatore legacy](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
               * [Aggiungi logica di visualizzazione e salta logica con il generatore legacy](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
               ...
               * [Eliminare tipi di oggetto in un modulo personalizzato con il generatore legacy](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)
         * Progettazione moduli {#form-designer}
            ...
            * Progettare un modulo personalizzato {#design-a-form}
               * [Progettare un modulo](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form-toc.md)
               ...
               * [Progettare un modulo da una copia con il progettista del modulo](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-from-copy.md)
               * [Aggiungere campi calcolati con il progettista del modulo](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/add-a-calculated-field.md)
               * [Organizzare e visualizzare in anteprima un modulo con il progettista del modulo](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/organize-a-form.md)
            * Gestire un modulo {#manage-a-form}
               ...
               * [Aggiunta o eliminazione di tipi di oggetto da un modulo personalizzato esistente con il progettista del modulo](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/manage-a-form/add-or-remove-objects-from-a-form.md)
               * [Rinominare un modulo personalizzato con il progettista del modulo](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/manage-a-form/rename-a-custom-form.md)
         * Gestire i moduli personalizzati {#manage-custom-forms}
            * [Gestire moduli e campi personalizzati](administration-and-setup/customize-workfront/create-manage-custom-forms/manage-custom-forms-toc.md)
   ...
   * Gestisci gruppi {#manage-groups}
      ...
      * Utilizzare gli oggetti di un gruppo {#group-objects}
         ...
         * [Gestisci progetti di gruppo](administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-portfolios.md)
   ...
   * Configurare le integrazioni {#configure-integrations}
      ...
      * [Accedere all’Aiuto per Adobe Workfront DAM](administration-and-setup/configure-integrations/access-help-workfront-dam.md)
   ...
   * Domande frequenti sugli amministratori {#admin-faq}
...
* Nozioni di base su Adobe Workfront {#basics}
   ...
   * Naviga in Adobe Workfront {#navigate}
      ...
      * [Adobe di esperienza unificata per Workfront](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/adobe-unified-experience.md)
      * [Domande frequenti sull’esperienza unificata di Adobe](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/unified-experience-faq.md)
   ...
   * Home {#home}
      ...
      * Nuova Home {#new-home}
         ...
         * [Introduzione alla nuova home](workfront-basics/using-home/new-home/get-started-with-new-home.md)
         * [Aggiungere, modificare o rimuovere widget in Nuova Home](workfront-basics/using-home/new-home/add-edit-remove-widgets-in-new-home.md)
      * Utilizzare l’area Home {#use-home-area}
         ...
         * [Creare elementi di lavoro dall&#39;area Home](workfront-basics/using-home/using-the-home-area/create-work-items-in-home.md)
   ...
   * Gestire account e profilo {#manage-account-profile}
      ...
      * Configurare il profilo utente {#configure-user-profile}
         ...
         * [Configurare il tempo libero personale in Adobe Workfront](workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/personal-time-overview.md)
   ...
   * App mobili {#mobile-apps}
      ...
      * Suggerimenti, trucchi e risoluzione dei problemi per le app mobili Adobe Workfront {#tips-tricks-for-mobile-apps}
         ...
         * [Messaggio di errore sull’app mobile di Adobe Workfront: &quot;Il tuo account non è abilitato per le API&quot;.](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/error-message-on-mobile-app.md)
...
* Gestisci lavoro {#manage-work}
   ...
   * Progetti {#projects}
      ...
      * Gestione progetti {#manage-projects}
         * [Gestione progetti](manage-work/projects/manage-projects/manage-projects-overview.md)
      ...
      * Definire un caso di business {#define-business-case}
         * [Definire un caso di business](manage-work/projects/define-a-business-case/define-business-case.md)
      ...
      * Finanze del progetto {#project-finances}
         * [Finanze del progetto](manage-work/projects/project-finances/project-finances-overview.md)
      ...
      * Suggerimenti, trucchi e risoluzione dei problemi per i progetti {#tips-tricks-troubleshooting-for-projects}
         * [Suggerimenti, trucchi e risoluzione dei problemi per i progetti](manage-work/projects/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-for-projects.md)
   ...
   * Gestione Portfolio {#portfolio-management}
      ...
      * Gestire i progetti in Portfoli Optimizer {#manage-projects-in-portfolio-optimizer}
         * [Gestire i progetti in Portfoli Optimizer](manage-work/portfolios/portfolio-optimizer/manage-projects-in-portfolio-optimizer.md)
         ...
         * [Assegna priorità ai progetti in Portfoli Optimizer](manage-work/portfolios/portfolio-optimizer/prioritize-projects-in-portfolio-optimizer.md)
...
* Rivedere e approvare il lavoro {#review-and-approve-work}
   ...
   * Revisioni e approvazioni dei documenti {#document-reviews-and-approvals}
      * [Revisioni e approvazioni dei documenti](review-and-approve-work/document-reviews-and-approvals/document-reviews-and-approvals.md)
      ...
      * Gestire le approvazioni dei documenti {#manage-document-approvals}
         * [Gestire le approvazioni dei documenti](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/manage-document-approvals.md)
         * [Creare un’approvazione documento](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md)
         * [Aggiungere revisori o approvatori aggiuntivi a un documento](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/add-additional-reviewers-or-approvers.md)
         * [Rimuovere approvatori o revisori da un documento](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/remove-approvers-or-reviewers.md)
      * Rivedere e approvare i documenti {#review-and-approve-documents}
         * [Rivedere e approvare i documenti](review-and-approve-work/document-reviews-and-approvals/review-and-approve-documents/review-and-approve-documents.md)
...
* Pianificazione scenario Adobe Workfront {#scenario-planner}
   ...
   * [Richiedere l&#39;accesso a un piano nella Pianificazione scenario](scenario-planner/request-access-to-plan.md)
...
* Maestro Adobe {#adobe-maestro}
   ...
   * Architettura Adobe Maestro {#adobe-maestro-architecture}
      * [Informazioni sull&#39;architettura](maestro/architecture-and-fields/architecture-and-fields-information.md)
      * [Creare aree di lavoro](maestro/architecture-and-fields/create-workspaces.md)
      * [Panoramica dei tipi di record e delle tassonomie](maestro/architecture-and-fields/overview-of-record-types-and-taxonomies.md)
      * [Crea tipi di record](maestro/architecture-and-fields/create-record-types.md)
      * [Creare tipi di record di tassonomia](maestro/architecture-and-fields/create-a-taxonomy.md)
      * [Connetti tipi di record](maestro/architecture-and-fields/connect-record-types.md)
      * [Crea campi](maestro/architecture-and-fields/create-fields.md)
      * [Modifica tipi di record](maestro/architecture-and-fields/edit-record-types.md)
      * [Modifica campi](maestro/architecture-and-fields/edit-fields.md)
      * [Eliminare le aree di lavoro](maestro/architecture-and-fields/delete-workspaces.md)
      * [Elimina tipi di record](maestro/architecture-and-fields/delete-record-types.md)
      * [Elimina campi](maestro/architecture-and-fields/delete-fields.md)
      * [Esempio di connessione di tipi di record e record](maestro/architecture-and-fields/example-connect-record-types-and-records.md)
      * [Elenco dei modelli di Workspace](maestro/architecture-and-fields/workspace-templates.md)
   * Accesso Adobe Maestro {#adobe-maestro-access}
      ...
      * [Concedere l’accesso a Adobe Maestro](maestro/access/grant-access.md)
   * Record Adobe Maestro {#adobe-maestro-records}
      * [Informazioni sui record](maestro/records/records-information.md)
   ...
   * Adobe Visualizzazioni Maestro {#adobe-maestro-views}
      * [Informazioni sulle visualizzazioni](maestro/views/views-information.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Adobe Workfront Fusion in Adobe Experience Cloud {#fusion-in-experience-cloud}
      ...
      * [Differenze di amministrazione basate sulla piattaforma (Adobe Workfront Fusion/Adobe Business Platform)](/help/quicksilver/workfront-fusion/fusion-in-admin-console/fusion-adobe-admin-console.md)
   * Connessioni in Adobe Workfront Fusion {#connections-in-fusion}
      ...
      * [Creare connessioni in Adobe Workfront Fusion](workfront-fusion/connections/connection-instruction-toc.md)
      * [Metadati di connessione](/help/quicksilver/workfront-fusion/connections/connection-metadata.md)
      ...
      * [Connettere Adobe Workfront Fusion a qualsiasi servizio web](workfront-fusion/connections/connect-wf-fusion-to-any-web-service.md)
      * [Connettere Adobe Workfront Fusion a un servizio web che utilizza l’autorizzazione del token API](workfront-fusion/connections/connect-wf-web-service-uses-api-token-auth.md)
      * [Connettere Adobe Workfront Fusion a Google Services con misure di sicurezza aggiornate](workfront-fusion/connections/connect-to-google-with-new-security-measures.md)
      ...
      * [Chiama l’API REST di MS Graph tramite Adobe Workfront Fusion HTTP > Creare un modulo di richiesta OAuth 2.0](workfront-fusion/connections/call-the-ms-graph-rest-api-.md)
   ...
   * Errori in Adobe Workfront Fusion {#errors-in-fusion}
      ...
      * [Gestione degli errori dei tentativi in Adobe Workfront Fusion](workfront-fusion/errors/retry.md)
      * [Gestione degli errori in Adobe Workfront Fusion](workfront-fusion/errors/throw.md)
   ...
   * Funzioni in Adobe Workfront Fusion {#functions-in-fusion}
      ...
      * [Funzioni generali di Adobe Workfront Fusion](workfront-fusion/functions/general-functions.md)
      * [Mappare gli elementi utilizzando le funzioni di Adobe Workfront Fusion](workfront-fusion/functions/map-using-functions.md)
      * [Funzioni data e ora in Adobe Workfront Fusion](workfront-fusion/functions/date-and-time-functions.md)
      ...
      * [Funzioni array in Adobe Workfront Fusion](workfront-fusion/functions/array-functions.md)
   ...
   * Mappatura in Adobe Workfront Fusion {#mapping-in-fusion}
      ...
      * [Informazioni sulla mappatura dei file in Adobe Workfront Fusion](workfront-fusion/mapping/about-mapping-files.md)
      * [Tipi di dati degli elementi in Adobe Workfront Fusion](workfront-fusion/mapping/item-data-types.md)
      * [Mappare un array in Adobe Workfront Fusion](workfront-fusion/mapping/map-an-array.md)
      * [Tipo di coercizione in Adobe Workfront Fusion](workfront-fusion/mapping/type-coercion.md)
   * Moduli in Adobe Workfront Fusion {#modules-in-fusion}
      ...
      * [Archivi dati in Adobe Workfront Fusion](workfront-fusion/modules/data-stores.md)
      ...
      * [Modulo Iterator in Adobe Workfront Fusion](workfront-fusion/modules/iterator-module.md)
   ...
   * Organizzazioni in Adobe Workfront Fusion {#organizations-in-fusion}
      ...
      * [Organizzazioni e team di Adobe Workfront Fusion](workfront-fusion/organizations/organizations-and-teams.md)
      ...
      * [Ruoli di organizzazione in Adobe Workfront Fusion](workfront-fusion/organizations/organization-roles.md)
   * Scenari in Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * [Panoramica sullo scenario Adobe Workfront Fusion](workfront-fusion/scenarios/scenario-overview.md)
      * [Creare uno scenario in Adobe Workfront Fusion](workfront-fusion/scenarios/create-a-scenario.md)
      * [Editor scenario in Adobe Workfront Fusion](workfront-fusion/scenarios/scenario-editor.md)
      * [Impostazioni dello scenario di base in Adobe Workfront Fusion](workfront-fusion/scenarios/basic-scenario-settings.md)
      ...
      * [Visualizzare e risolvere esecuzioni incomplete in Adobe Workfront Fusion](workfront-fusion/scenarios/view-and-resolve-incomplete-executions.md)
      ...
      * [Pianificazione di uno scenario in Adobe Workfront Fusion](workfront-fusion/scenarios/schedule-a-scenario.md)
      ...
      * Modelli di scenario Adobe Workfront Fusion {#fusion-scenario-templates}
         ...
         * [Domande frequenti sui modelli di Adobe Workfront Fusion](workfront-fusion/scenarios/templates/fusion-templates-faqs.md)
         * [Modelli di Adobe Workfront Fusion attualmente disponibili](workfront-fusion/scenarios/templates/currently-available-fusion-templates.md)
      * [Esempio di scenario Adobe Workfront Fusion: connessione di e-mail, parser di testo e fogli Google](workfront-fusion/scenarios/example-connect-email-text-parser-gsheets.md)
      * [Ripristinare una versione dello scenario in Adobe Workfront Fusion](workfront-fusion/scenarios/restore-a-scenario-version.md)
   ...
   * App Workfront Fusion e relativi moduli {#fusion-apps-and-modules}
      ...
      * [Moduli bozza di Workfront](workfront-fusion/apps-and-their-modules/workfront-proof-modules.md)
      ...
      * [Moduli DevOps di Azure](workfront-fusion/apps-and-their-modules/azure-dev-ops.md)
      ...
      * [Moduli evento](workfront-fusion/apps-and-their-modules/cvent-modules.md)
      ...
      * [Moduli Dropbox](workfront-fusion/apps-and-their-modules/dropbox-modules.md)
      * [Moduli e-mail](workfront-fusion/apps-and-their-modules/email-modules.md)
      * [Crittografia](workfront-fusion/apps-and-their-modules/encryptor-modules.md)
      ...
      * [Moduli calendario di Google](workfront-fusion/apps-and-their-modules/google-calendar-modules.md)
      ...
      * [Moduli Forms di Google](workfront-fusion/apps-and-their-modules/google-forms-modules.md)
      * [Moduli Google Sheets](workfront-fusion/apps-and-their-modules/google-sheets-modules.md)
      * [Moduli diapositive di Google](workfront-fusion/apps-and-their-modules/google-slides-modules.md)
      * [Moduli di Google Team Drive](workfront-fusion/apps-and-their-modules/google-team-drive-modules.md)
      * Moduli HTTP {#fusion-http-modules}
         * [Moduli HTTP](workfront-fusion/apps-and-their-modules/http-modules/http-modules-1.md)
         * [HTTP > Creare un modulo di richiesta](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-request.md)
         * [HTTP > Creare un modulo di richiesta di autorizzazione di base](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-basic-auth-request.md)
         * [HTTP > Creare un modulo di richiesta OAuth 2.0](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-oauth-2-request.md)
         * [HTTP > Crea un modulo di richiesta di autorizzazione del certificato client](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-client-cert-auth-request.md)
         * [HTTP > Creare una richiesta di autorizzazione della chiave API](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-api-key-auth-request.md)
      ...
      * [Moduli Microsoft Dynamics 365](workfront-fusion/apps-and-their-modules/microsoft-dynamics-365-modules.md)
      ...
      * [Moduli di Microsoft SQL Server](workfront-fusion/apps-and-their-modules/microsoft-sql-server-modules.md)
      ...
      * [Moduli SDL Managed Translation](workfront-fusion/apps-and-their-modules/sdl-managed-translation-modules.md)
      ...
      * [Parser testo](workfront-fusion/apps-and-their-modules/text-parser.md)
      ...
      * [Amplia moduli](workfront-fusion/apps-and-their-modules/widen-modules.md)
...
* Integrazioni Adobe Workfront {#adobe-workfront-integrations}
   ...
   * Adobe Workfront per Creative Cloud {#workfront-for-creative-cloud}
      ...
      * Carica documenti e bozze con il plug-in Adobe Workfront per applicazioni Creative Cloud {#upload-docs-proofs-wf-cc}
         * [Carica documenti e bozze da [!DNL Adobe Workfront plugin] al [!DNL Creative Cloud]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/upload-documents-and-proofs.md)
   ...
   * Adobe Workfront per G Suite {#workfront-for-g-suite}
      ...
      * [Accedere e uscire da Adobe Workfront per G Suite](workfront-integrations-and-apps/workfront-for-g-suite/log-in-and-out-wf-for-gsuite.md)
      * [Accedere ai contenuti della Home di Adobe Workfront da G Suite](workfront-integrations-and-apps/workfront-for-g-suite/access-wf-home-content-from-g-suite.md)
      ...
      * [Visualizzazione e gestione di documenti da G Suite](workfront-integrations-and-apps/workfront-for-g-suite/view-and-manage-documents-in-gsuite.md)
      * [Visualizzare e gestire i dettagli dell’oggetto Adobe Workfront da G Suite](workfront-integrations-and-apps/workfront-for-g-suite/view-manage-work-item-details-in-gsuite.md)
      ...
      * [Rispondi a una notifica di aggiornamento di Adobe Workfront da G Suite](workfront-integrations-and-apps/workfront-for-g-suite/reply-to-wf-update-notification-from-gsuite.md)
      * [Trasformare le e-mail di G Suite in oggetti e aggiornamenti di Adobe Workfront](workfront-integrations-and-apps/workfront-for-g-suite/turn-gsuite-emails-into-wf-objects-and-updates.md)
      * [Creare un’attività di Adobe Workfront in G Suite utilizzando il contenuto dell’e-mail](workfront-integrations-and-apps/workfront-for-g-suite/create-wf-task-in-gsuite-using-email-content.md)
      * [Creare un problema di Adobe Workfront in G Suite utilizzando il contenuto dell’e-mail](workfront-integrations-and-apps/workfront-for-g-suite/create-wf-issue-in-g-suite-using-email-content.md)
   ...
   * Adobe Workfront per Outlook {#workfront-for-outlook}
      ...
      * [Aggiungere un messaggio e-mail di Outlook a un progetto come attività o problema](workfront-integrations-and-apps/using-workfront-with-outlook/add-outlook-email-to-project-as-task-or-issue.md)
   ...
   * Adobe Workfront per Salesforce {#workfront-for-salesforce}
      ...
      * [Creare progetti Adobe Workfront dagli oggetti Salesforce](workfront-integrations-and-apps/using-workfront-with-salesforce/create-wf-projects-from-salesforce-objects.md)
...
* Workfront Proof {#workfront-proof}
   ...
   * Guida introduttiva a Workfront Proof {#get-started-wf-proof}
      ...
      * Esempi di flussi di lavoro {#workflow-examples}
         ...
         * [Utilizzo di designer e project manager in Workfront Proof](workfront-proof/wp-getstarted/workflow-examples/work-designers-project-managers.md)
      ...
      * Informazioni di sistema in Workfront Proof {#system-info-wf-proof}
         ...
         * [Anteprima ambiente di test sandbox: bozza Workfront](workfront-proof/wp-getstarted/system-information/preview-sandbox.md)
      ...
      * Domande frequenti sulle bozze di Workfront {#wf-proof-faq}
         * [Bozza di Workfront: domande frequenti](workfront-proof/wp-getstarted/faqs/faqs.md)
   ...
   * Utilizzare bozze e file in Workfront Proof {#work-with-proofs-in-wf-proof}
      ...
      * Funzioni di base di Workfront Proof {#basic-features-in-wf-proof}
         * [Funzioni di base di Workfront Proof](workfront-proof/wp-work-proofsfiles/basic-features/basic-features.md)
         ...
         * [Ricerca di Workfront Proof](workfront-proof/wp-work-proofsfiles/basic-features/search.md)
      ...
      * Creare bozze e file {#create-proofs-and-files}
         ...
         * [Carica file e contenuti Web in Workfront Proof](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/upload-files-web-content.md)
      ...
      * Gestire il lavoro {#manage-your-work}
         ...
         * [Gestisci file in Workfront Proof](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-files.md)
         * [Gestisci elementi nella pagina Visualizzazioni in Workfront Proof](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md)
         ...
         * [Creare e gestire visualizzazioni personalizzate in Bozza di Workfront](workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md)
         ...
         * [Visualizzare lo stato e l’avanzamento di una bozza in Workfront Proof](workfront-proof/wp-work-proofsfiles/manage-your-work/view-progress-and-status-of-proof.md)
      ...
      * Organizzare il lavoro {#organize-your-work}
         ...
         * [Backup dei dati di Workfront Proof](workfront-proof/wp-work-proofsfiles/organize-your-work/back-up-data.md)
      ...
      * Condividere bozze e file {#share-proofs-and-files}
         ...
         * [Condividere collegamenti bozza in Workfront Proof](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof-links.md)
   ...
   * Amministrazione account Workfront Proof {#wf-proof-account-admin}
      ...
      * Impostazioni account in Workfront Proof {#account-settings-in-wf-proof}
         ...
         * [Configurare il profilo di autorizzazione di una bozza utente in Workfront Proof](workfront-proof/wp-acct-admin/account-settings/config-user-pref-in-wp.md)
         ...
         * [Single Sign-On in Workfront Proof: configurazione AD FS](workfront-proof/wp-acct-admin/account-settings/sso-in-wp-adfs-configuration.md)
         * [Profili delle autorizzazioni della bozza in Workfront Proof](workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md)
         ...
         * [Configurare l’area di rilascio in Workfront Proof](workfront-proof/wp-acct-admin/account-settings/configure-dropzone-in-wp.md)
         * [Configurazione account per le integrazioni in Workfront Proof](workfront-proof/wp-acct-admin/account-settings/integrations-account-setup.md)
         ...
         * [Visualizzare la cronologia degli account amministratore di Workfront Proof della tua organizzazione](workfront-proof/wp-acct-admin/account-settings/view-org-wp-acct-history.md)
      ...
      * Bozza Workfront per branding {#branding-wf-proof}
         * [Bozza Workfront per branding](workfront-proof/wp-acct-admin/branding/branding.md)
      ...
      * Account satellite in Workfront Proof {#satellite-accounts-in-wf-proof}
         * [Account satellite in Workfront Proof](workfront-proof/wp-acct-admin/satellite-accounts/satellite-accounts.md)
         * [Account satellite in Workfront Proof](workfront-proof/wp-acct-admin/satellite-accounts/sat-accts-in-wp.md)
      ...
      * Suggerimenti, trucchi e risoluzione dei problemi per l’amministrazione dell’account Workfront Proof {#ttt-wf-proof-account-admin}
         ...
         * [Domande frequenti: Workfront Proof - Migrazione da Stati Uniti a EMEA](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/faq-wp-us-to-emea-mig.md)
   * Impostazioni fatturazione bozza Workfront {#wf-proof-billing-settings}
      * [Impostazioni fatturazione bozza Workfront](workfront-proof/wp-billingsettings/wp-billing-settings.md)
      * Gestire la fatturazione {#manage-billing}
         ...
         * [Pagina Fatturazione bozza Workfront](workfront-proof/wp-billingsettings/manage-your-billing/wp-billing-page.md)
         ...
         * [Chiudi l’account Workfront Proof](workfront-proof/wp-billingsettings/manage-your-billing/close-wp-acct.md)
   * Notifiche e promemoria bozza {#proof-notifications-and-reminders}
      ...
      * Evitare i filtri anti-spam {#avoid-spam-filters}
         ...
         * [Configura le e-mail di prova di Workfront per evitare filtri anti-spam](workfront-proof/wp-emailsntfctns/avoiding-spam-filters/configure-wp-emails-avoid-spam-filters.md)
   ...
   * Gestione di utenti e contatti in Workfront Proof {#managing-users-in-wf-proof}
      ...
      * Utenti {#users}
         ...
         * [Crea utenti con Workfront Proof](workfront-proof/wp-mnguserscontacts/users/create-users.md)
   ...
   * Workfront Proof per dispositivi mobili {#wf-proof-mobile}
      * [Workfront Proof per dispositivi mobili](workfront-proof/wp-mobile/wp-mobile.md)
   ...
   * Angolo tecnico Workfront Proof {#wf-proof-tech-corner}
      ...
      * Risoluzione dei problemi in Workfront Proof {#troubleshooting-wf-proof}
         ...
         * [Comprendere in che modo la cache e i cookie influiscono su Workfront Proof](workfront-proof/wp-tech-corner/troubleshooting/how-cache-cookies-affect-pv.md)
         ...
         * [Risoluzione dei problemi - Visualizzatore bozze di Workfront](workfront-proof/wp-tech-corner/troubleshooting/proofing-viewer.md)
   * Integrazioni Workfront Proof {#wf-proof-integrations}
      ...
      * Box {#box}
         ...
         * [Cartelle Sincronizza Casella Con Bozza Workfront](workfront-proof/wp-integrations/box/sycn-box-folder.md)
...
* API ADOBE WORKFRONT {#adobe-workfront-api}
   ...
   * API dei webhook dei documenti {#document-webhooks-api}
      * [Articoli API sui webhook dei documenti](wf-api/doc-wbhks-api/document-webhooks-api.md)
