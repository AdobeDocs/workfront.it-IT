...
* Annunci sui prodotti {#product-announcements}
   ...
   * Versioni dei prodotti {#product-releases}
      ...
      * Versione del secondo trimestre 2026 {#release-26-q2}
         ...
         * [Miglioramenti per gli amministratori del primo trimestre 2026](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md)
         * [Primo trimestre 2026 Altri miglioramenti](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md)
