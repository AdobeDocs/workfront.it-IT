...
* Amministrazione e configurazione {#administration-and-setup}
   ...
   * Gestione utente {#add-users}
      ...
      * Crea e gestisci i team {#create-manage-teams}
         ...
         * [Crea una team](administration-and-setup/add-users/create-and-manage-teams/create-a-team-from-setup.md)
         * [Modifica le impostazioni di un team](administration-and-setup/add-users/create-and-manage-teams/edit-team-settings-from-setup.md)
   * Personalizza Adobe Workfront {#customize}
      ...
      * Modelli di layout {#layout-templates}
         ...
         * [Personalizzare il pannello di sinistra](administration-and-setup/customize-workfront/use-layout-templates/customize-left-panel.md)
...
* Nozioni di base su Adobe Workfront {#basics}
   ...
   * App mobili {#mobile-apps}
      ...
      * Utilizza le app Adobe Workfront per dispositivi mobili {#use-workfront-mobile-app}
         ...
         * [Commento sulle prove in Android](workfront-basics/mobile-apps/using-the-workfront-mobile-app/comment-on-proofs-android.md)
         * [Commento sulle bozze in iOS](workfront-basics/mobile-apps/using-the-workfront-mobile-app/comment-on-proofs-ios.md)
         * [Adobe Systems Workfront per la gestione dei dispositivi mobili (MDM)](workfront-basics/mobile-apps/using-the-workfront-mobile-app/wf-mdm.md)
         * [Configurazione Adobe Systems Workfront per MobileIron](workfront-basics/mobile-apps/using-the-workfront-mobile-app/wf-mobileiron-configs.md)
      ...
      * Usa visualizzazione Adobe Workfront {#use-workfront-view}
         ...
         * [Filtra elenchi di progetti in Adobe Systems Workfront Visualizza](workfront-basics/mobile-apps/using-workfront-view/filter-project-lists-in-workfront-view.md)
      ...
      * Suggerimenti, trucchi e risoluzione dei problemi per le app mobili Adobe Workfront {#tips-tricks-for-mobile-apps}
         * [Suggerimenti, trucchi e risoluzione dei problemi per Adobe Systems le app di Workfront Mobile](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/tips-tricks-and-troubleshooting-mobile.md)
         * [Errore Invia messaggio sul app di Adobe Systems Workfront Mobile: &quot;Your account is not API enabled.&quot;](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/error-message-on-mobile-app.md)
   * Suggerimenti, trucchi e risoluzione dei problemi per Adobe Systems Workfront Basics {#tips-tricks-for-basics}
      * [Suggerimenti, trucchi e risoluzione dei problemi per Adobe Systems Workfront Basics](workfront-basics/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-basics.md)
      ...
      * [Più schede di browser causano la disconnessione di Workfront](/help/quicksilver/workfront-basics/tips-tricks-and-troubleshooting/multiple-browser-tabs-cause-logout.md)
* Agile {#agile}
...
* Gestisci lavoro {#manage-work}
   ...
   * Progetti {#projects}
      ...
      * Gestisci progetti {#manage-projects}
         ...
         * [Comunicare con i membri del team di progetto](manage-work/projects/manage-projects/communicate-with-project-team-members.md)
...
* Reporting {#reporting}
   ...
   * Rapporti {#reports}
      ...
      * Esempi di visualizzazione, filtro e raggruppamento personalizzati {#custom-view-samples}
         ...
         * [Visualizza: creazione dei dettagli dei problemi per attività e progetti](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-originating-issue-details-tasks-projects.md)
         * [Visualizza: ore pianificate e ore effettive per assegnazione in una visualizzazione attività](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-planned-hours-actual-hours-assignment-task-view.md)
         ...
         * [Visualizza: percentuale di utente Job Role della disponibilità di FTE](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-user-job-role-percentage-fte-availability.md)
         * [Visualizza: utente tempo libero personale](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-user-personal-time-off.md)
         * [Tracciare un report in base a un campo personalizzato a selezione multipla](reports-and-dashboards/reports/custom-view-filter-grouping-samples/chart-report-by-multi-select-custom-field.md)
      * Risorse in modalità testo {#text-mode}
         ...
         * [Raccolte di riferimenti in un rapporto](reports-and-dashboards/reports/text-mode/reference-collections-report.md)
         ...
         * [Crea filtri complessi in modalità testo con istruzioni EXISTS](reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md)
...
* Rivedere e approvare il lavoro {#review-and-approve-work}
   ...
   * Revisione e approvazione di risorse e documenti {#document-reviews-and-approvals}
      ...
      * Imposta e gestisci approvazioni risorse e documenti {#manage-asset-review-and-approval}
         ...
         * [Utilizzare insieme nuove approvazioni di documenti e prove](review-and-approve-work/document-reviews-and-approvals/doc-approvals-and-proofing.md)
      ...
      * Rivedi e approva risorse e documenti {#review-and-approve-documents}
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * Richieste di Adobe Workfront Planning {#adobe-workfront-planning-requests}
      ...
      * [Inviare richieste Adobe Systems Workfront Planning per creare record](planning/requests/submit-requests.md)
   * Adobe Systems Viste di Pianificazione del fronte lavoro {#adobe-workfront-planning-views}
      * [Visualizzazioni: indice dell&#39;articolo](planning/views/views-information.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Introduzione ad Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      ...
      * [Utilizzo di file di grandi dimensioni in Fusion](/help/quicksilver/workfront-fusion/get-started/fusion-large-files.md)
   ...
   * Scenari in Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * [Generare un segmento di scenario utilizzando IA](/help/quicksilver/workfront-fusion/scenarios/add-a-module-with-ai.md)
   ...
   * App Workfront Fusion e relativi moduli {#fusion-apps-and-modules}
      ...
      * [[!DNL Draft.js] moduli](/help/quicksilver/workfront-fusion/apps-and-their-modules/draft-js-modules.md)
      ...
      * [Moduli di SharePoint](workfront-fusion/apps-and-their-modules/sharepoint-modules.md)
      ...
      * [Parser di testo](workfront-fusion/apps-and-their-modules/text-parser.md)
      * [Utensileria](workfront-fusion/apps-and-their-modules/tools-modules.md)
...
* API Adobe Workfront {#adobe-workfront-api}
   ...
   * API Document Webhooks {#document-webhooks-api}
      ...
      * [Gestione Errore webhook per documenti](wf-api/doc-wbhks-api/docu-webhooks-errors.md)
   ...
   * Suggerimenti, trucchi e risoluzione dei problemi per l&#39;API Adobe Workfront {#tips-troubleshooting-apis}
      ...
      * [Formato di dominio per Adobe Systems chiamate API di Workfront](wf-api/tips-tricks-and-troubleshooting/locate-domain-for-api.md)
      ...
      * [Aggiungere opzioni di correzione avanzate durante la creazione di una prova tramite l&#39;API di Adobe Systems Workfront](wf-api/tips-tricks-and-troubleshooting/api-create-proof-options-json.md)
      * [Opzioni configurazione per OPTASK copyIssue](wf-api/tips-tricks-and-troubleshooting/copyissue-options.md)
