...
* Annunci sui prodotti {#product-announcements}
   ...
   * Rilasci di prodotti {#product-releases}
      ...
      * Versione {#release-25-q2} del secondo trimestre 2025
         ...
         * [Altri miglioramenti durante il periodo di rilascio della versione del secondo trimestre 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-other-enhancements.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * Record di Adobe Workfront Planning {#adobe-workfront-planning-records}
      ...
      * [Creazione di oggetti Workfront da Workfront Planning](planning/records/create-workfront-objects-from-workfront-planning.md)
