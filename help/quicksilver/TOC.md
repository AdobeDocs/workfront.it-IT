...
* Annunci sui prodotti {#product-announcements}
   ...
   * Rilasci di prodotti {#product-releases}
      ...
      * Versione 23.2 {#release-23-2}
         ...
         * [Attività di rilascio 23.2: Settimana del 20 febbraio 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-20.md)
...
* Amministrazione e configurazione {#administration-and-setup}
   ...
   * Personalizzare Adobe Workfront {#customize}
      ...
      * Moduli personalizzati {#custom-forms}
         ...
         * [Aggiungere un’immagine o un altro widget di risorse a un modulo personalizzato](administration-and-setup/customize-workfront/create-manage-custom-forms/add-widget-or-edit-its-properties-in-a-custom-form.md)
         * [Aggiungi un’interruzione di sezione](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-section-break-to-a-custom-form.md)
         ...
         * [Aggiungi dati calcolati](administration-and-setup/customize-workfront/create-manage-custom-forms/add-calculated-data-to-custom-form.md)
         * [Riutilizzare un campo personalizzato calcolato esistente](administration-and-setup/customize-workfront/create-manage-custom-forms/use-existing-calc-field-new-custom-form.md)
         * [Posizionare campi e widget personalizzati](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
         * [Condivisione per campi e widget personalizzati](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
         * [Riutilizzare un campo o un widget personalizzato](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
         * [Aggiungere logica di visualizzazione e saltare logica](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
         ...
         * [Eliminare i tipi di oggetto in un modulo personalizzato](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)
