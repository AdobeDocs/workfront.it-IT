...
* Nozioni di base su Adobe Workfront {#basics}
   ...
   * Aggiorna elementi di lavoro e visualizza aggiornamenti {#update-work-items-view-updates}
      ...
      * [Esperienza con commenti unificati](workfront-basics/updating-work-items-and-viewing-updates/unified-commenting-experience.md)
...
* Agile {#agile}
   ...
   * Utilizzare strumenti di pianificazione agili nelle bacheche {#agile-planning-boards}
      ...
      * [Gestione raccolte](/help/quicksilver/agile/use-boards-agile-planning-tools/manage-collections.md)
...
* Gestire le risorse {#manage-resources}
   ...
   * Gestione risorse {#resource-management}
      ...
      * [Strumenti di pianificazione risorse obsoleti in Adobe Workfront](resource-mgmt/resource-mgmt-overview/deprecate-resource-scheduling.md)
      * [Migrare da Programmazione risorse al Bilanciatore dei carichi di lavoro](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
