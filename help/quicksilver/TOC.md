...
* Nozioni di base su Adobe Workfront {#basics}
   ...
   * Pagina Home {#home}
      ...
      * Utilizzare l’area Home {#use-home-area}
         ...
         * [Utilizza il widget Richieste personali](workfront-basics/using-home/using-the-home-area/my-requests-widget.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * Architettura di Adobe Workfront Planning {#adobe-workfront-planning-architecture}
      ...
      * [Aggiungi tipi di record per più aree di lavoro](planning/architecture/add-cross-workspace-record-types.md)
