...
## Spostare un documento nella nuova area Documenti
...
1. Vai al progetto, all&#39;attività o al problema che contiene il documento, quindi seleziona **Documenti**.
1. Trovare il documento necessario.
1. Fai clic su **Sposta** nella parte inferiore della pagina.

![Posizione icona di spostamento a pagina](assets/move-new-doc.png)
...
1. Digitare il nome dell&#39;**Issue**, **Project** o **Task** nella casella di testo.
   ...
   >[!NOTE]
   >
   >Puoi passare a un altro progetto, attività o problema solo utilizzando l’archiviazione cloud di Adobe.
