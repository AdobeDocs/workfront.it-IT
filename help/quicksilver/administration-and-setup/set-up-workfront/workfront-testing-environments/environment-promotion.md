...
| Oggetto promovibile | Oggetti secondari inclusi |
| --- | --- |
...
3. origine (stringa con convalida URL)
4. stato (stringa con convalida del valore)
5. version (numero intero)
6. metadati (raccolta)
7. packageEntities (insieme)
