...
1. (Condizionale) A seconda dell’ambiente da cui accedi a Trimestri personalizzati, effettua una delle seguenti operazioni:

   * Nell&#39;ambiente di produzione, fare clic su **[!UICONTROL Preferenze progetto]** > **[!UICONTROL Progetti].**
   * <span class="preview">Nell&#39;ambiente di anteprima, fare clic su **[!UICONTROL Trimestri personalizzati]**.</span>
