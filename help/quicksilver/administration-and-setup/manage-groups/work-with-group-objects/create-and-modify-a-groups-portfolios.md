...
title: Creare e modificare i portafogli di un gruppo
...
1. Nel pannello a sinistra, fai clic su **Portfolio** per elencare i portfolio associati al gruppo (ed eventuali sottogruppi al di sotto di esso).
     ...
     <tr> 
      ...
      <td> 
       <ol> 
        ...
        <li value="4">Fai clic sul pulsante Indietro del browser per tornare all’elenco dei portfolio del gruppo.</li> 
       </ol> </td>
     </tr> 
     <tr> 
