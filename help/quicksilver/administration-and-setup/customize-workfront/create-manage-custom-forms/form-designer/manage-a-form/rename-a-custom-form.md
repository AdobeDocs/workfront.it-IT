---
title: Rinominare un modulo personalizzato con il progettista del modulo
user-type: administrator
product-area: system-administration
navigation-topic: create-and-manage-custom-forms
description: È possibile rinominare i moduli personalizzati esistenti con il progettista del modulo.
author: Courtney
...
1. Seleziona il modulo personalizzato da rinominare, quindi fai clic su **Modifica**.
1. Per modificare il titolo, fare clic sul nome del modulo.
1. Per modificare la descrizione, fare clic su nella casella di testo della descrizione.
