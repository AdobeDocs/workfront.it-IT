---
title: Creare o modificare un modulo personalizzato
...
# Creare o modificare un modulo personalizzato

È possibile creare o modificare un nuovo modulo personalizzato. Entrambe le attività sono spiegate in questo articolo.

Per informazioni sulla creazione di un nuovo modulo personalizzato da uno esistente, vedere [Copiare un modulo personalizzato per crearne uno nuovo](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/copy-custom-form-to-create-a-new-one.md).
