...
Per informazioni sui modelli di layout e sui profili aziendali, vedere [Panoramica sui profili aziendali](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/business-profiles.md).
...
1. Nella casella visualizzata fare clic su **Aggiungi un utente, una mansione, un team, un gruppo o un livello di accesso**, inizia a digitare il nome di un utente, una mansione, un team, un gruppo o un livello di accesso, quindi fai clic sul nome quando viene visualizzato nel menu a discesa.
   ...
   A destra del nome di qualsiasi utente, mansione, team, gruppo o livello di accesso già assegnato a un altro modello di layout viene visualizzata l&#39;icona Info ![Icona Info](assets/info-icon.png). Passa il puntatore del mouse sull&#39;icona per visualizzare il nome del modello di layout e decidere se ignorare l&#39;assegnazione esistente.

1. Ripeti i due passaggi precedenti per assegnare il modello di layout ad altri utenti, ruoli, team, gruppi o livelli di accesso in base alle esigenze.
...
* A un determinato livello di accesso all&#39;utente
...
* Livello di accesso: se alla persona non viene assegnato un modello di layout come singolo utente, né come utente con una mansione principale, né come membro di un team predefinito, né come membro di un gruppo predefinito, viene visualizzato il modello assegnato al proprio livello di accesso.
