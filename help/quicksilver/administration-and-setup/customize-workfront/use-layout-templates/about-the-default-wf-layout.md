...
Il layout predefinito è la disposizione dell&#39;icona del menu principale ![Menu principale](assets/main-menu-icon-left-nav.png), del pannello sinistro e delle visualizzazioni, dei raggruppamenti e dei filtri prima che un amministratore Adobe Workfront apporti modifiche utilizzando un modello di layout.
...
### Menu principale predefinito per i tipi di licenza legacy

La tabella seguente mostra le voci predefinite del menu principale e gli elementi del pannello sinistro visualizzati per ciascun tipo di licenza legacy:
