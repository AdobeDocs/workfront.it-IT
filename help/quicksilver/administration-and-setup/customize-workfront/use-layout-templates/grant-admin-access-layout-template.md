...
1. Clic **Concedi l’accesso a** nella sezione superiore della pagina.
1. Nella casella visualizzata fare clic su **Aggiungi un gruppo**, inizia a digitare il nome del gruppo, fai clic sul nome quando viene visualizzato, quindi fai clic su **Fine**.
