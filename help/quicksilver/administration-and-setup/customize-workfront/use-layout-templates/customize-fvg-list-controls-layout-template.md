...
1. Fare clic sulla freccia giù ![](assets/down-arrow-blue.png) in **Personalizzare gli elementi visualizzati dagli utenti**, quindi fai clic su **Elenchi** nel menu a discesa visualizzato.

   ![](assets/customize-what-users-see-dropdown-on-pg-adobe-branding.png)

1. Fare clic sulla freccia giù ![](assets/down-arrow-blue.png) in **Seleziona un elenco da personalizzare**, quindi selezionare il tipo di oggetto Workfront per il quale si desidera personalizzare i controlli Filtro, Visualizza e Raggruppamento.
   ...
   >
   >* Nell’elenco dei filtri visualizzati quando fanno clic sull’icona del filtro ![](assets/filter-nwepng.png) sopra un elenco:
   >   
...
1. (Facoltativo) Se si desidera modificare il filtro, la visualizzazione o il raggruppamento predefiniti per il modello di layout, passare il puntatore del mouse sul filtro, sulla visualizzazione o sul raggruppamento, quindi fare clic su **Imposta come predefinito**.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Deselezionare o selezionare la casella accanto al controllo elenco che si desidera nascondere o visualizzare.</p> <p>Se una casella di controllo è disattivata, non è possibile nasconderla. Predefinito <img src="assets/default-pill.png"> l'impostazione per ogni controllo elenco è disattivata perché non è possibile nascondere l'impostazione attualmente configurata come predefinita.</p> </td> 
     </tr> 
     <tr> 
