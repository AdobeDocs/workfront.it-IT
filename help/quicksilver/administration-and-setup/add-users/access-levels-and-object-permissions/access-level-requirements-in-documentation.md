---
title: Requisiti dei livelli di accesso
...
# Requisiti dei livelli di accesso nella documentazione di Workfront
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <li>Per istruzioni su come un amministratore di Workfront può individuare il piano Workfront della tua organizzazione, consulta <a href="/help/quicksilver/administration-and-setup/get-started-wf-administration/firewall-overview.md#view-your-organizations-cluster-and-workfront-plan" class="MCXref xref">Visualizza il piano Workfront e il cluster della tua organizzazione</a>.</li></ul> </td> 
  </tr> 
  <tr> 
   ...
   <ul>
   <li>Nuovo: <a href="/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/licenses-overview.md" class="MCXref xref">Panoramica sulle nuove licenze</a></li>
   <li>Corrente: <a href="/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/wf-licenses.md" class="MCXref xref">Panoramica sulle licenze</a></li></ul></li>
  ...
  <tr> 
   ...
   <ul>
   <li>Nuovo: <a href="/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/access-level-overview.md" class="MCXref xref">Panoramica dei nuovi livelli di accesso</a></li>
   <li>Corrente: <a href="/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md" class="MCXref xref">Panoramica dei livelli di accesso</a></li></ul></li>
    ...
    <li>Se sei un amministratore di Workfront, consulta <a href="../../../administration-and-setup/add-users/configure-and-grant-access/configure-access.md" class="MCXref xref">Configurare l’accesso ad Adobe Workfront</a> per ulteriori informazioni sulla concessione dell'accesso a oggetti specifici nel livello di accesso, vedere.</li>  
   <li>Se disponi del livello di accesso corretto e non disponi ancora dell’accesso, chiedi all’amministratore di Workfront se ha impostato restrizioni aggiuntive nel livello di accesso. Per informazioni su come un amministratore di Workfront può modificare il tuo livello di accesso, consulta <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Creare o modificare livelli di accesso personalizzati</a>.</li>
    </td>
  </tr> 
  <tr> 
   ...
   <p>Per ulteriori informazioni sulla richiesta di accesso aggiuntivo a un oggetto, vedere <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Richiedi accesso agli oggetti</a>.</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   Per informazioni sulle licenze Fusion, vedi <a href="/help/quicksilver/workfront-fusion/get-started/license-automation-vs-integration.md" class="MCXref xref">Licenze Workfront Fusion</a>.
   </td> 
  </tr> 
 </tbody> 
</table>
