...
1. Fai clic sull&#39;icona ![](assets/main-menu-icon.png) del *[!UICONTROL *Main Menu]** nell&#39;angolo superiore destro di [!DNL Adobe Workfront], quindi fai clic su **[!UICONTROL Setup]** ![](assets/gear-icon-settings.png).
