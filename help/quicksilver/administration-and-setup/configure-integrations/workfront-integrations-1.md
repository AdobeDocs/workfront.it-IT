...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><ul><li>Workfront deve trovarsi in un Admin Console a cui è assegnato un ID organizzazione.</li><li>Workfront ed Experience Manager Assets o Assets Essentials devono essere assegnati come prodotto all’utente che configura l’integrazione.</li></ul></td>   <td> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p><b>NOTA</b>: la configurazione del calendario di [!UICONTROL Outlook] è completamente separata dal componente aggiuntivo [!DNL Outlook] ([!DNL Outlook] Integration o [!DNL Workfront for Outlook]). Non è necessaria alcuna installazione per configurare il calendario.</p> <p>Per ulteriori informazioni, vedere <a href="../../workfront-basics/using-home/using-the-home-area/configure-home-calendar-view.md" class="MCXref xref">Configurare le impostazioni di visualizzazione di [!UICONTROL Home Calendar]</a>.</p> </td> 
   <td> </td> 
   <td> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p>Per ulteriori informazioni, vedere <a href="../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/use-workfront-with-ms-teams.md" class="MCXref xref">[!DNL Adobe Workfront for Microsoft Teams]: indice articolo</a>.</p> </td> 
   <td> 
    <ul> 
...
* [!DNL Workfront Fusion]
  ...
  Per ulteriori informazioni, vedere [[!DNL Adobe Workfront Fusion] panoramica](../../workfront-fusion/get-started/workfront-fusion-overview.md).
