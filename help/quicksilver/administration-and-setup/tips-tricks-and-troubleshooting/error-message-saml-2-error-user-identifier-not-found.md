...
Le richieste sul server ADFS non sono corrette
...
Sul server ADFS, assicurati che sia presente un&#39;attestazione per l&#39;ID del nome:
...
1. Fai clic con il pulsante destro del mouse sull’attendibilità del componente correlato ad Adobe Workfront e seleziona **[!UICONTROL Modifica regole di attestazione]**.
1. Verifica che l&#39;attestazione disponga di un **[!UICONTROL Tipo di attestazione in uscita]** di **[!UICONTROL ID nome]**.
