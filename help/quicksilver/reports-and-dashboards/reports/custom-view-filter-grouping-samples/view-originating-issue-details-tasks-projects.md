...
description: Quando un problema viene convertito in un’attività o in un progetto, viene stabilita una relazione tra l’attività o il progetto e il problema. In questa visualizzazione vengono visualizzati i seguenti campi del problema che vengono completati automaticamente al completamento dell’attività o del progetto - MODIFICA.
...
Per ulteriori informazioni, consulta anche [Visualizza: visualizza le informazioni originali sui problemi negli elenchi di attività e progetti](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md).
