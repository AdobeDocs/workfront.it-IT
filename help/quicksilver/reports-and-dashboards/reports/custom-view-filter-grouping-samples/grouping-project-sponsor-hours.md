...
1. Sostituisci il testo con il seguente codice:
   ...
   <pre>group.0.linkedname=progetto:sponsor:nome<br>group.0.name=<br>group.0.valuefield=progetto:sponsor:nome<br>group.0.valueformat=HTML<br>textmode=true<br></pre>
