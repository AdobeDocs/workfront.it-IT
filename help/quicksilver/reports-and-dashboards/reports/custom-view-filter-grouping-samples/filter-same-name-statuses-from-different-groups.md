...
È possibile assegnare uno stato attività al gruppo A denominato *Nuovo stato* con la chiave di 3 lettere *NST*. È possibile che al gruppo B sia assegnato un altro stato di attività denominato anche *Nuovo stato* con la chiave di 3 lettere *NES.* Anche se i nomi per i 2 stati possono essere identici, il codice di 3 lettere è sempre univoco.
