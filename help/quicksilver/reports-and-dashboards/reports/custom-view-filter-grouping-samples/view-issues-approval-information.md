...
title: 'Visualizza: problemi con le informazioni di approvazione'
description: Nella visualizzazione dei problemi riportata di seguito vengono illustrati il processo di approvazione, la fase, i nomi degli approvatori e lo stato del problema prima dell'approvazione. Alcuni di questi campi non sono accessibili tramite il generatore di interfacce standard.
author: Courtney
...
# Visualizzazione: problemi relativi alle informazioni sull’approvazione

<!--Audited: 11/2024-->

Nella visualizzazione dei problemi riportata di seguito vengono illustrati il processo di approvazione, la fase, i nomi degli approvatori e lo stato del problema prima dell&#39;approvazione. Alcuni di questi campi non sono accessibili tramite il generatore di interfacce standard.
...
## Visualizza problemi con le informazioni di approvazione
