...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Gestire le autorizzazioni per un report per modificare un raggruppamento in un report</p> <p>Gestire le autorizzazioni per un raggruppamento </p> <p>Per informazioni sulla richiesta di accesso aggiuntivo, consulta <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Richiedi accesso agli oggetti </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Seleziona il raggruppamento da personalizzare, quindi fai clic sul pulsante **Modifica** icona.
   ...
   ![Seleziona l’icona Modifica.](assets/customizegrouping-nwe-standard-350x291.png)
...
1. (Facoltativo e condizionale) Quando visualizzi un elenco aggiornato, seleziona **Comprimi questo raggruppamento per impostazione predefinita** se si desidera che i risultati del raggruppamento vengano visualizzati compressi anziché espansi. Questa impostazione è disabilitata per impostazione predefinita e i risultati del raggruppamento vengono sempre visualizzati nell&#39;elenco espanso.
   ...
   Per informazioni sugli elenchi aggiornati e legacy, consulta la sezione &quot;La differenza tra gli elenchi aggiornati e legacy&quot; nell’articolo [Introduzione agli elenchi in Adobe Workfront](../../../workfront-basics/navigate-workfront/use-lists/view-items-in-a-list.md).
...
1. Clic **Salva come nuovo raggruppamento** per sostituire il raggruppamento corrente con le modifiche apportate.
