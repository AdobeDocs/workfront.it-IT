...
Oltre al livello di accesso concesso agli utenti, è anche possibile concedere loro le autorizzazioni per visualizzare o gestire report specifici a cui si ha accesso per la condivisione. Per ulteriori informazioni sui livelli di accesso e sulle autorizzazioni, vedere [Funzionamento dei livelli di accesso e delle autorizzazioni](../../../administration-and-setup/add-users/access-levels-and-object-permissions/how-access-levels-permissions-work-together.md).

Le autorizzazioni sono specifiche per un elemento in Workfront e definiscono le azioni che è possibile eseguire su tale elemento.

>[!NOTE]
>
>Un amministratore di Workfront può aggiungere o rimuovere autorizzazioni per qualsiasi elemento nel sistema, per tutti gli utenti, senza esserne il proprietario.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Visualizza l'accesso o versioni successive a Report, Dashboard, Calendari</p></td> 
  </tr> 
  <tr> 
   <td role="rowheader">Autorizzazioni sugli oggetti</td> 
   <td> <p>Visualizza le autorizzazioni o versioni successive del report</p></td> 
  </tr> 
 </tbody> 
</table>
...
## Considerazioni sulla condivisione dei report

Oltre alle considerazioni riportate di seguito, vedere [Condividere report, dashboard e calendari](../../../workfront-basics/grant-and-request-access-to-objects/permissions-reports-dashboards-calendars.md).

* Puoi condividere i report creati con altri utenti, team, gruppi, ruoli lavorativi o aziende. Puoi anche condividere con te i rapporti che altri utenti hanno creato e che sono stati condivisi.
...
## Modalità di condivisione dei report

È possibile condividere i report in Workfront nel modo seguente:

* Manualmente, come descritto nella sezione [Condividere un report](#share-a-report) riportata di seguito.
* Ereditando automaticamente le autorizzazioni di visualizzazione da un dashboard che contiene il report condiviso. Per informazioni sulla visualizzazione delle autorizzazioni ereditate sugli oggetti, vedere [Visualizzare le autorizzazioni ereditate sugli oggetti](../../../workfront-basics/grant-and-request-access-to-objects/view-inherited-permissions-on-objects.md).

## Condividere un report {#share-a-report}

La condivisione di uno o più report di un elenco è identica.

1. Accedi a un elenco di report e seleziona uno o più report, quindi fai clic sull&#39;icona **Condividi** ![Condividi](assets/share-icon.png).
...
1. Nel campo **Concedi l&#39;accesso al report**, inizia a digitare il nome dell&#39;utente, del team, del ruolo del processo, del gruppo o della società con cui desideri condividere il report, quindi selezionalo quando viene visualizzato.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Consente al destinatario di accedere per visualizzare il report nell'area <strong>Report</strong> ed eseguirlo.</p> <p>È possibile fare clic sull'icona <strong>Impostazioni avanzate</strong> a destra per specificare se si desidera che l'utente o gli utenti possano <strong>condividerla</strong> con chiunque nel sistema.</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">Gestione</td> 
      <td> <p>Consente al destinatario l’accesso completo al report in modifica.</p> <p>Puoi fare clic sull'icona <strong>Impostazioni avanzate</strong> a destra per specificare se desideri che l'utente o gli utenti possano <strong>eliminare</strong> il report dal sistema e <strong>condividerlo</strong> con chiunque nel sistema.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. (Facoltativo) Fai clic sul menu a discesa **Solo le persone invitate possono accedere** nella casella di condivisione, quindi scegli tra le seguenti opzioni:
   ...
   * **Tutti i membri del sistema possono visualizzare**: selezionate questa opzione affinché tutti gli utenti di Workfront che dispongono dell&#39;accesso ai report possano visualizzare il report.
...
1. (Facoltativo) Fai clic sull&#39;icona **Ingranaggio** ![Impostazioni icona ingranaggio](assets/gear-icon-settings-with-dn-arrow.jpg) nell&#39;angolo superiore destro della casella di condivisione, quindi, facoltativamente, seleziona la seguente opzione:
   ...
   * **Rendi pubblico agli utenti esterni**: seleziona questa opzione per generare un URL che possa essere condiviso con altri utenti. Chiunque abbia l’URL può accedere al rapporto senza disporre di una licenza Adobe Workfront.
     ...
     >[!NOTE]
     >
     >Se il report include una richiesta e viene condiviso pubblicamente, gli utenti che eseguono il report tramite il collegamento di condivisione pubblico non potranno eseguire il report utilizzando la richiesta. Vedranno il report senza il prompt applicato, a meno che non accedano a Workfront e accedano al report senza utilizzare il collegamento di condivisione pubblico. Per ulteriori informazioni sulle limitazioni della condivisione di report con prompt, vedere la sezione [Limitazioni della condivisione di report richiesti](../../../reports-and-dashboards/reports/creating-and-managing-reports/add-prompt-report.md#limitations-of-running-public-prompted-reports) nell&#39;articolo [Aggiungere un prompt a un report](../../../reports-and-dashboards/reports/creating-and-managing-reports/add-prompt-report.md).
