...
1. Inizia aggiungendo un blocco di visualizzazione con tipo di visualizzazione **KPI** a un rapporto, come spiegato in [Aggiungi o modifica un blocco di visualizzazione nell&#39;area di lavoro Reporting](../../../reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md).
