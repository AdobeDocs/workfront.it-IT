...
title: Eliminare una dashboard dell’area di lavoro
...
> Se si elimina una dashboard contenente un report classico, il report classico non verrà eliminato.
...
1. Nell&#39;angolo superiore destro, seleziona l&#39;icona **Altro** ![Altro](assets/more-icon.png), quindi seleziona **Elimina dashboard**.
   ![Elimina dashboard](assets/delete-dashboard.png)
