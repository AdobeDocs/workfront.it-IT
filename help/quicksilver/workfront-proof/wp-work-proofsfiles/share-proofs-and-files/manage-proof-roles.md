...
title: Gestisci ruoli bozza in [!DNL Workfront Proof]
...
# Gestisci ruoli bozza in [!DNL Workfront Proof]
...
I ruoli di bozza ti consentono di concedere autorizzazioni agli utenti limitati dal profilo di autorizzazione configurato nel loro profilo utente. (Per ulteriori informazioni sui profili di autorizzazione, vedere [Profili di autorizzazione di bozza in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md).)
...
* [Condividi bozza in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof.md)
...
![no.png](assets/no.png) non dispone dei diritti di modifica per la bozza

>[!NOTE]
>
>Se una cartella viene condivisa con un utente di [!DNL Workfront Proof], verranno automaticamente assegnati diritti di sola lettura a tutti gli elementi esistenti e aggiunti successivamente nella cartella.

Per ulteriori informazioni, vedere [Condividi cartelle in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/share-folders.md).
...
![no.png](assets/no.png) Impossibile modificare o eliminare i commenti aggiunti da altri
...
![cleaner.png](assets/cleaner.png) può condividere la bozza con altri utenti
...
![cleaner.png](assets/cleaner.png) può eliminare commenti e risposte sulla bozza (creati da se stessi o da altri)
...
I ruoli di bozza possono essere assegnati ai revisori nella pagina [!UICONTROL Nuova bozza] durante il processo di creazione della bozza (1).

![Ruoli_bozza_-_Nuova_pagina_bozza.png](assets/proof-roles---new-proof-page-350x184.png)
...
![Ruoli_bozza_-_Nuova_Versione_pagina.png](assets/proof-roles---new-version-page-350x164.png)

### Bozze esistenti {#existing-proofs}

Se desideri modificare il ruolo di una persona su una bozza esistente, puoi farlo sulla pagina [!UICONTROL Dettagli bozza] modificando in linea il suo ruolo nella sezione del flusso di lavoro (1).

![Ruoli_bozza_-_Dettagli_bozza_pagina_2.png](assets/proof-roles---proof-details-page-2-350x131.png)
...
![Ruoli_bozza_-_Proof_Viewer.png](assets/proof-roles---proof-viewer-350x300.png)

## Ruoli bozza predefiniti

È possibile impostare il proprio ruolo di bozza predefinito nella pagina [!DNL Proofing Defaults] delle impostazioni personali. Ciò significa che quando si viene aggiunti a una bozza, il ruolo di bozza predefinito viene popolato automaticamente. Tieni presente che questo ruolo può essere modificato a livello di bozza da un utente con diritti di modifica su una bozza.
...
Per ulteriori informazioni, vedere [Impostazioni personali in [!DNL Workfront Proof]](../../../workfront-proof/wp-getstarted/personal-settings/personal-settings.md).
...
Nella pagina [!UICONTROL Nuova bozza] è possibile assegnare al creatore della bozza un ruolo di bozza diverso (diverso dal ruolo predefinito).

Impossibile modificare o rimuovere da una bozza il creatore della bozza.

### Proprietari {#owners}

Per impostazione predefinita, il creatore è anche il proprietario della bozza; tuttavia, il creatore può impostare un altro utente come proprietario della bozza durante la creazione iniziale della bozza (nella pagina [!UICONTROL Nuova bozza]).
...
Una volta creata la bozza, è ancora possibile cambiare il proprietario. Chiunque disponga dei diritti di modifica per la bozza potrà cambiarne la proprietà a un altro utente tramite la pagina [!UICONTROL Dettagli bozza] (vedi sotto).

La possibilità di cambiare il proprietario di una bozza è particolarmente utile dal punto di vista della gestione del flusso di lavoro. Consente alla persona responsabile del progetto di assumere la proprietà delle bozze, assegnando loro i diritti di modifica sulle bozze e la possibilità di visualizzarle nella visualizzazione [!UICONTROL Bozze personali].

Per cambiare il proprietario della bozza tramite la pagina [!UICONTROL Dettagli bozza]:

* Fare clic sul menu Azioni accanto al nome della persona che si desidera impostare come Proprietario.
* Selezionare [!UICONTROL **Rendi proprietario**] dal menu a discesa.
* In alternativa, puoi fare clic nel campo [!UICONTROL **Proprietario**] accanto all&#39;immagine della bozza e scegliere il nuovo Proprietario dal menu a discesa visualizzato.
...
>* Nessun campo personalizzato nella pagina [!UICONTROL Nuova bozza].
>* La bozza non è stata assegnata a una cartella.
>* Nessun tag applicato alla bozza.

Per delegare temporaneamente la proprietà della bozza in [!DNL Workfront Proof], vedere [Designazione dei proprietari di bozze temporanei in [!DNL Workfront Proof]](../../../workfront-proof/wp-getstarted/personal-settings/designate-temp-proof-owners.md).
