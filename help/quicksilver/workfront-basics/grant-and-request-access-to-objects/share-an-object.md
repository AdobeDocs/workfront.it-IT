...
Per informazioni sulla condivisione di oggetti in Workfront, vedere gli articoli seguenti:

* Per i progetti, vedere [Condividere un progetto](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-project.md).

* Per le attività, vedere [Condividere un&#39;attività](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-task.md).

* Per i problemi, vedi [Condividi un problema](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-an-issue.md).

* Per i portfolio, consulta [Condividere un portfolio](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-portfolio.md)

* Per i programmi, vedere [Condividere un programma](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-program.md).

* Per i documenti, vedere [Condividere un documento](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/document-permissions.md).

* Per i modelli, vedere [Condividere modelli di progetto](../../manage-work/projects/create-and-manage-templates/share-project-template.md).
