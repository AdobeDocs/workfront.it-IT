  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>[!UICONTROL Bacheche]: <a href="/help/quicksilver/agile/boards-overview.md">Panoramica bacheche</a></li>
     <li>[!UICONTROL Blueprints]: <a href="/help/quicksilver/administration-and-setup/blueprints/blueprints-overview.md">Panoramica blueprint</a></li>
     <li>[!UICONTROL Priorities]: <a href="/help/quicksilver/workfront-basics/priorities/get-started-with-priorities.md">Introduzione alle priorità</a></li>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td> <p class="bold">[!UICONTROL Configurazione]</p> </td> 
