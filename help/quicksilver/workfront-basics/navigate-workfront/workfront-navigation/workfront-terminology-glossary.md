...
<td> <p>Si tratta del costo associato alle risorse di definizione del budget per un progetto. </p>
  ...
  <tr> 
   ...
   <td> <p>In [!DNL Workfront] sono disponibili due tipi di calendari: il Calendario predefinito di [!UICONTROL] e i report calendario.</p> <p>Il [!UICONTROL Home Calendar] è un calendario personale che consente a un utente di gestire il carico di lavoro rispetto alle ore disponibili in [!DNL Workfront]. Gli utenti possono inoltre integrare il proprio [!UICONTROL Home Calendar] con [!DNL Outlook] ([!DNL Google] e [!DNL Microsoft] integrazione in arrivo). </p> <p>Per ulteriori informazioni sul Calendario predefinito di [!UICONTROL], vedere <a href="../../../workfront-basics/using-home/using-the-home-area/home-calendar-view.md" class="MCXref xref">[!UICONTROL Calendario predefinito] vista</a>.</p> <p>Un report calendario è un report dinamico in cui gli utenti possono visualizzare la data e altri dettagli importanti di un evento, tra cui la data di scadenza, lo stato del lavoro e l'utente a cui l'evento è assegnato.</p> <p> Per ulteriori informazioni sui report calendario, vedere <a href="../../../reports-and-dashboards/reports/calendars/calendar-reports-overview.md" class="MCXref xref">Panoramica sui report calendario</a>.</p> </td> 
  </tr> 
   <tr> 
...
<p>L’Allineamento data pianificata è visibile negli elenchi e nei rapporti relativi a progetti, attività e problemi. </p></td> 
  ...
  <tr> 
   ...
   <!--
    ...
    <p>Per informazioni sui calcoli di [!UICONTROL Planned Revenue] nel rapporto Utilizzo di [!UICONTROL], vedere <a href="../../../resource-mgmt/resource-utilization/view-utilization-information.md">Visualizzare le informazioni sull'utilizzo delle risorse </a>. </p> 
    </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Insieme di schede e sezioni portale definito dall'amministratore che viene visualizzato nell'applicazione [!DNL Workfront] [!UICONTROL Home] e in altre dashboard.</td> 
  </tr> 
  <tr> 
  ...
  <tr data-mc-conditions="SnippetConitions_MaturityModel.Ad hoc"> 
   ...
   <td> <p>Una raccolta di progetti che hanno caratteristiche unificanti. Questi progetti in genere competono per le stesse risorse, budget o fasce orarie. È possibile suddividere i Portfoli in Programmi e associare i progetti ai Programmi prima che vengano aggiunti a un Portfolio.</p> <p>Per ulteriori informazioni sui portfolio, vedere <a href="../../../manage-work/portfolios/portfolios-overview/portfolio-overview.md">Panoramica sui Portfoli in [!DNL Adobe Workfront]</a>.</p> 
   </td> 
  </tr> 
  <tr data-mc-conditions="SnippetConitions_MaturityModel.Integrated"> 
  ...
  <tr data-mc-conditions="SnippetConitions_MaturityModel.Integrated"> 
   ...
   <td> <p>Attività che deve essere completata prima del completamento di un'attività dipendente. È anche un'attività contrassegnata come dipendenza [!UICONTROL] per un'altra attività. I predecessori consentono al planner di impostare la logica di dipendenza dalla sequenza, ad esempio di avviare un'attività al termine di un'altra attività.</p> <p>Per ulteriori informazioni, vedere <a href="../../../manage-work/tasks/use-prdcssrs/predecessors-overview.md" class="MCXref xref">Panoramica sui predecessori delle attività</a>.</p> </td> 
  </tr> 
  <tr> 
...
<tr> 
  ...
  <tr data-mc-conditions="SnippetConitions_MaturityModel.Managed"> 
   ...
   <td> <p>Un’attività che deve essere eseguita come un passaggio verso il raggiungimento di un obiettivo finale (completamento del progetto).</p> <p>Per ulteriori informazioni, vedere <a href="../../../manage-work/tasks/task-information/tasks-overview.md" class="MCXref xref">Panoramica attività</a>.</p> </td> 
  </tr> 
  <tr> 
