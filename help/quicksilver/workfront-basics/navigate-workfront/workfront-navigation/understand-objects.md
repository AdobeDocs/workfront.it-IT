...
* Quando si personalizzano i nomi degli oggetti utilizzando una  [!UICONTROL Modello di layout], si consiglia di assegnare  [!UICONTROL Modelli di layout] intorno alle unità aziendali (team o gruppi).\
...
A seconda dell&#39;oggetto selezionato per il report, è possibile accedere solo agli oggetti direttamente collegati all&#39;oggetto del report.
...
È possibile creare rapporti sui seguenti oggetti quando si utilizza il generatore di rapporti in [!DNL Workfront] applicazione web:
