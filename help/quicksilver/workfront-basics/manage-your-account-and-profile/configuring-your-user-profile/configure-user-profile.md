...
* Scegli la formattazione del **[!UICONTROL tema scuro]** per [!DNL CX Enterprise].
* Imposta **[!UICONTROL Preferenze]** per [!DNL CX Enterprise], incluse le preferenze per la lingua primaria e secondaria.
