 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> 
    ...
    </ul> <p>Per ulteriori informazioni sulla richiesta di accesso aggiuntivo per gli oggetti, vedere <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Richiedi accesso agli oggetti </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
La modifica delle informazioni in un modulo personalizzato associato a un oggetto è identica per tutti gli oggetti. Per informazioni sugli oggetti che possono disporre di un modulo personalizzato, vedere [Panoramica dei moduli personalizzati](../../administration-and-setup/customize-workfront/create-manage-custom-forms/custom-forms-overview.md).

1. Passare a un oggetto per il quale si desidera modificare le informazioni nel modulo personalizzato.
1. Clic **`<Object type>`Dettagli** nel pannello a sinistra.

   Ad esempio, quando modifichi le informazioni in un modulo personalizzato del progetto, fai clic su **Dettagli progetto**.
...
1. Fai clic sull’icona Modifica nell’angolo superiore destro della pagina ![](assets/edit-icon.png).
1. Inizia a immettere informazioni in qualsiasi campo a cui hai accesso.
   ...
   Se nel modulo non sono ancora state immesse informazioni, fare clic su **Aggiungi+** per qualsiasi campo a cui hai accesso e inizia a immettere informazioni.
...
1. Clic **Salva modifiche**.
   ...
   <span class="preview">Quando i campi dipendenti della pagina vengono modificati, i campi calcolati del modulo personalizzato vengono ricalcolati in tempo reale in modo dinamico. Puoi visualizzare i risultati aggiornati senza salvare il modulo. Ciò si applica ai campi calcolati nei moduli predefiniti e nei moduli personalizzati.</span>
...
1. Fai clic su **Altro** menu ![](assets/more-icon.png) a destra del nome dell&#39;oggetto, quindi fare clic su **Ricalcola espressioni**.
...
1. Fai clic su **Icona Modifica**.
1. Clic **Forms personalizzato** nel menu a sinistra, seleziona quindi **Ricalcolare Espressioni Personalizzate**.
1. Clic **Salva** **Modifiche**.
...
>1. Fai clic su **Altro** menu ![](assets/more-icon.png), quindi fai clic su **Ricalcolare Espressioni Personalizzate**.
>
