...
È possibile aggiungere un aggiornamento su un oggetto Adobe Workfront (progetto, attività o problema) per comunicare l’avanzamento dell’oggetto. Gli utenti assegnati o abbonati all’oggetto possono visualizzare l’aggiornamento. Puoi anche assegnare tag agli utenti per attirare la loro attenzione sull’aggiornamento.
...
Nella scheda Aggiornamenti per un oggetto Workfront sono visualizzati due tipi di informazioni:
