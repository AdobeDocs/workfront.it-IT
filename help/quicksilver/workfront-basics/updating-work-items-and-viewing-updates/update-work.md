...
Puoi aggiungere un aggiornamento a un oggetto Adobe Workfront (progetto, attività o problema) per comunicare l’avanzamento dell’oggetto. Gli utenti che sono assegnati o abbonati all’oggetto possono visualizzare l’aggiornamento. Puoi anche assegnare tag agli utenti per attirare la loro attenzione sull’aggiornamento.

È possibile aggiungere aggiornamenti a un oggetto dalle seguenti aree di Workfront:
...
1. (Facoltativo) Per aggiungere la formattazione RTF all’aggiornamento, utilizza gli attributi nella **Rich Text** durante la digitazione.
   ...
   | **Attributo** | **Pulsante barra degli strumenti** | **Tasti di scelta rapida Mac** | **Tasti di scelta rapida PC** |
   |---|---|---|---|
...
1. (Facoltativo) Aggiungi tutte le emoticon all’aggiornamento.
...
1. (Facoltativo) Per allegare un’immagine all’aggiornamento, fai clic sul pulsante **Immagine** icona ![](assets/addimageicon-35x32.png) e passare all&#39;immagine nel computer.\
   Oppure\
   Trascinare l&#39;immagine nell&#39;area di aggiornamento.

   >[!NOTE]
   >
   >* Per poter visualizzare l&#39;icona Immagine, l&#39;amministratore di Workfront deve abilitare l&#39;aggiunta di immagini.
   >* La dimensione massima del file di immagine è 7 MB. I tipi di file immagine supportati sono .jpg, .gif e .png.
   >* Le immagini sono accessibili solo dalla scheda Aggiornamenti di un oggetto e non dalla scheda Documenti.
   >* È possibile inviare un aggiornamento con un’immagine e senza testo.


1. (Facoltativo) Specificare uno dei seguenti elementi:
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>Identifica gli utenti a cui deve essere notificata l’aggiornamento. Gli utenti assegnati o sottoscritti all'oggetto ricevono automaticamente una notifica quando viene effettuato un aggiornamento.<br><p>Per informazioni su come includere altri utenti in un aggiornamento, consulta <a href="../../workfront-basics/updating-work-items-and-viewing-updates/tag-others-on-updates.md" class="MCXref xref">Assegna tag ad altri utenti in caso di aggiornamenti</a>.</p></td> 
     </tr> 
     <tr> 
   ...
   Non è possibile modificare lo stato di un elemento di lavoro che si trova nello stato In attesa di approvazione.</p></td>
     ...
     <tr> 
      ...
      <td> <p>Disattiva questa opzione per impedire agli utenti esterni alla società di avere accesso alla visualizzazione di questo aggiornamento.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
Nella scheda Aggiornamenti di un oggetto Workfront vengono visualizzati due tipi di informazioni:
