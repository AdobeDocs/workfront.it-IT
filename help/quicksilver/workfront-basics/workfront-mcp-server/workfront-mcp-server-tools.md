...
| Inviare documenti alla cartella AEM | `approvals_send_documents_to_aem_folder` | Sposta uno o più documenti Workfront in una cartella collegata ad AEM. | Scrittura |
