...
Per informazioni sulla creazione delle tassonomie, vedere [Creare tipi di record di tassonomia](../architecture-and-fields/create-a-taxonomy.md).
...
Per informazioni sulla creazione delle aree di lavoro, consulta [Creare aree di lavoro](../architecture-and-fields/create-workspaces.md).

Per informazioni sui tipi di record inclusi in ogni modello, vedere [Elenco dei modelli di Workspace](../architecture-and-fields/workspace-templates.md).
...
Per ulteriori informazioni sulle tassonomie, consulta [Creare una tassonomia](../architecture-and-fields/create-a-taxonomy.md).
...
1. (Facoltativo) Fai clic su **+** nell&#39;angolo superiore destro della tabella per aggiungere altri campi al tipo di record. Per ulteriori informazioni, consulta [Crea campi](../architecture-and-fields/create-fields.md).
