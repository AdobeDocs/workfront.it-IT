...
È stato aggiornato l’aspetto dell’icona per l’area Pianificazione nel menu principale. Per informazioni, consulta [Panoramica di Adobe Workfront Planning](/help/quicksilver/maestro/maestro-overview.md).
...
Per ulteriori informazioni, consulta [Modifica campi](/help/quicksilver/maestro/fields/edit-fields.md).
...
Per informazioni, consulta [Crea tipi di record](/help/quicksilver/maestro/architecture/create-record-types.md).
...
Per ulteriori informazioni sulle notifiche di pianificazione di Workfront, vedere [Notifiche di Adobe Workfront Planning: indice articolo](/help/quicksilver/maestro/notifications/notifications-information.md).
