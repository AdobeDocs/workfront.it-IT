   ...
   <table style="table-layout:auto"> 
    <tbody> 
     <tr> 
      ...
      <td> <p>La modifica del nome comporta anche la modifica del nome della connessione [!DNL Workfront] oggetto.</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>[!UICONTROL Descrizione]</strong></td> 
      <td> <p>La modifica della descrizione comporta anche la modifica della descrizione nella connessione [!DNL Workfront] oggetto.</p> </td> 
     </tr> 
     <tr>
     ...
     <tr>
      ...
      <td><p>Seleziona la colonna per la scheda.</p></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td><p>La modifica di questa data comporta anche la modifica della data di completamento pianificata nella connessione [!DNL Workfront] oggetto.</p></td>
     </tr>
      <tr>
      <td role="rowheader"><strong>Stima [!UICONTROL]</strong></td>
      <td><p>Il numero di ore per il completamento della scheda.</p><p>Se utilizzi il consenso per la funzione anticipata per [!DNL Workfront] [!UICONTROL Bacheche], la modifica della stima cambia anche il valore dei punti del brano sulla connessa [!DNL Workfront] oggetto.</p><p>Se non accettate le feature precedenti, questo campo è solo una immissione manuale e il valore non può essere superiore a 99.</p></td>
     </tr>
     <tr>
     ...
     <tr> 
      <td role="rowheader"><strong>[!UICONTROL Elementi dell'elenco di controllo]</strong> </td> 
