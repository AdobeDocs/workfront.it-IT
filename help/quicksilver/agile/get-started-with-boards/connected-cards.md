   ...
   <table style="table-layout:auto"> 
    <tbody> 
     ...
     <tr>
      ...
      <td><p>Numero di ore per il completamento della scheda.</p><p>Se utilizzi l’opzione di consenso per le funzioni iniziali di [!DNL Workfront] [!UICONTROL Boards], cambiare la stima cambia anche il valore dei punti della storia sulla connessione [!DNL Workfront] oggetto.</p><p>Se non si sceglie di utilizzare le funzioni iniziali, questo campo è solo una voce manuale e il valore non può essere superiore a 99.</p></td>
     </tr>
     <tr>
