...
La tabella seguente illustra le funzioni principali delle bacheche e il loro stato di rilascio corrente. Le funzioni a cui è possibile accedere tramite l’opzione di consenso anticipato potrebbero non essere disponibili nella versione completa, in base all’input ricevuto.

<table style="table-layout:auto"> 
 <tbody> 
  <tr> 
   <th><strong>Descrizione o nome della funzione</strong></th>
  ...
  <tr>
   <td>Creare schede connesse a [!DNL Workfront] oggetti</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Aggiungere un team a una bacheca o a una scheda</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Aggiungi una colonna di acquisizione</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
   <td>Raggruppare le schede su una bacheca</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Visualizzare lo stato su una scheda</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
   <td>Utilizza un contatore di schede nelle colonne</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Schede di sola visualizzazione nella colonna Acquisizione</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
   <td>Mappa il campo Stima sulla scheda al campo Punti storia sull’attività</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
   <td>Creare flussi di lavoro e aggiungere bacheche ai flussi di lavoro</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Definisci uno stato predefinito per le schede spostate in colonne</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
   <td>Registra ore su schede collegate</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
   <td>Aggiungere campi personalizzati alle schede collegate</td>
   <td>Rilasciato</td>
  </tr>
  <tr>
...
1. In una bacheca, fai clic su **[!UICONTROL Feedback]** pulsante.
1. Compila il modulo, quindi fai clic su **[!UICONTROL Invia]**.

## Domande frequenti sull’opt-in anticipato delle funzioni
...
Quando [!DNL Workfront] l&#39;amministratore abilita le funzioni preliminari per le bacheche; tutti gli utenti dell&#39;organizzazione hanno prestato il consenso.

Tuttavia, il [!DNL Workfront] L’amministratore può nascondere l’opzione Bacheche dal [!UICONTROL Menu principale] per singoli utenti o gruppi di utenti con un modello di layout. Per informazioni, consulta [Personalizzare [!UICONTROL Menu principale] utilizzo di un modello di layout](/help/quicksilver/administration-and-setup/customize-workfront/use-layout-templates/customize-main-menu.md).

>[!NOTE]
>
>Ciò non impedisce agli utenti di accedere alle bacheche utilizzando un URL. Gli impedisce solo di vedere il [!DNL Boards] opzione in [!UICONTROL Menu principale].
