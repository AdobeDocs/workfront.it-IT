...
1. Fai clic su **[!UICONTROL Aggiungi raccolta]** in [!UICONTROL Raccolte] area del dashboard.
...
1. Fai clic su **[!UICONTROL Aggiungi bacheca]** sulla [!UICONTROL Schede] della raccolta.
