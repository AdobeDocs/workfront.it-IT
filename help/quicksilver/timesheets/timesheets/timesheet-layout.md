...
![Pannello Timesheet a sinistra](assets/timesheet-left-panel-unshimmed-redesign.png)
...
![Area Aggiornamenti nel pannello Timesheet di sinistra](assets/timesheet-updates-with-all-tab.png)
...
![Pannello di riepilogo](assets/timesheet-summary-panel-on-updates.png)
...
![Intervallo di tempo scheda orario](assets/timesheet-time-frame-log-time-area.png)
...
![Commenti sulle ore](assets/timesheet-hour-entry-comment-button-unshimmed-redesign.png)
...
![Commento immissione ore](assets/hour-entry-comment-under-task-in-timesheet-unshimmed-redesign.png)
