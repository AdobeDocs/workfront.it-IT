...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <ul><li>Revisione o superiore per registrare le ore generali in una scheda attività</li>
   <li> Lavoro o superiore per l'accesso alle ore di un progetto, di un'attività o di un problema</li></ul>
   </td> 
  </tr> 
  <tr> 
