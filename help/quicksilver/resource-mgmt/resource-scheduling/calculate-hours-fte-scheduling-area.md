...
title: Configurare il modo in cui Workfront calcola la disponibilità di ore risorsa e FTE per l’area di pianificazione
description: L’amministratore di Adobe Workfront determina il modo in cui Workfront calcola la disponibilità delle risorse e l’allocazione degli utenti a livello di sistema (considerando le ore e la disponibilità di ETP) al momento della configurazione delle preferenze di Gestione risorse.
author: Alina
...
# Configurare il modo in cui Workfront calcola la disponibilità di ore risorsa e FTE per l’area di pianificazione
...
L’amministratore di Adobe Workfront determina il modo in cui Workfront calcola la disponibilità delle risorse e l’allocazione degli utenti a livello di sistema (considerando le ore e la disponibilità di ETP) al momento della configurazione delle preferenze di Gestione risorse.

Possono scegliere di utilizzare uno dei seguenti elementi:
...
* Quando si consente a Workfront di assegnare automaticamente le risorse, come descritto nell’articolo seguente:
...
* Quando vengono visualizzati gli indicatori di allocazione, come descritto nel seguente articolo:

   * La sezione &quot;Indicatori di allocazione&quot; nell&#39;articolo  [Gestione delle allocazioni utente nelle aree di programmazione](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
