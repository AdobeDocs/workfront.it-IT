...
description: Panoramica del calcolo delle ore e dell'FTE per gli utenti e i ruoli nella pianificazione risorse.
author: Lisa
...
# Panoramica del calcolo di ore ed FTE per utenti e ruoli in pianificazione risorse
...
FTE (Full Time Equivalent) è una misura del tempo che rappresenta la quantità di ore dedicate al lavoro reale durante un giorno o una settimana per un utente o una mansione.
...
L’amministratore di Workfront determina il modo in cui viene calcolato il tempo disponibile per un utente selezionando una delle seguenti opzioni nell’area Gestione risorse di Configurazione:
...
Ad esempio, se il valore di Ore disponibili per un utente è 40 e l&#39;utente è in grado di svolgere un ruolo principale per il 75% del tempo e un altro ruolo per il 25% del tempo, la Programmazione delle risorse mostra che il valore di Ore disponibili per il ruolo principale per una settimana è 30 ore e che il valore di Ore disponibili per l&#39;altro ruolo è 10 ore. In questo caso, l’FTE per il ruolo principale è 0,75 e l’FTE per l’altro ruolo è 0,25.
...
Nella tabella seguente viene illustrato come vengono calcolate le ore disponibili e l&#39;FTE disponibile per l&#39;utente nella Programmazione risorse in base al metodo utilizzato dall&#39;amministratore di sistema per il calcolo dell&#39;FTE nelle Preferenze di gestione risorse.
...
Eccezioni alla pianificazione e indisponibilità potrebbero influire sulla quantità di ore pianificate o FTE. Per ulteriori informazioni, consulta [Configurare le preferenze di gestione delle risorse](../../administration-and-setup/set-up-workfront/configure-system-defaults/configure-resource-mgmt-preferences.md).
...
In Pianificazione risorse è possibile visualizzare le stesse informazioni come FTE o ore.
...
>[!NOTE]
>
>La pianificazione dell&#39;utente viene ignorata quando si calcola l&#39;FTE per tutti i valori eccetto FTE Disponibile (AVL) nella Programmazione delle risorse. Per il calcolo viene preso in considerazione solo lo Schedule predefinito.
